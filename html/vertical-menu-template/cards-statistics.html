...
<html
  ...
  <head>
    ...
    <meta name="robots" content="noindex, nofollow" />
      ...
      <title>Demo: Cards Statistics- UI elements | Sneat - Bootstrap Dashboard PRO</title>
    ...
    <div class="col-lg-3 col-md-6 col-sm-6">
      <div class="card">
        <div class="card-header d-flex align-items-center justify-content-between">
          ...
          <div class="dropdown">
            <button class="btn btn-text text-body-secondary p-0" type="button" id="totalSalesList" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Today <i class="icon-base bx bx-chevron-down"></i></button>
        ...
        <div class="card-body text-center">
          <div class="d-flex justify-content-center mb-3">
            <div class="avatar avatar-md flex-shrink-0">
              <span class="avatar-initial avatar-shadow-primary rounded-circle"><i class="icon-base bx bx-trending-up icon-26px"></i></span>
            </div>
          </div>
    ...
    <div class="col-lg-3 col-md-6 col-sm-6">
      <div class="card">
        <div class="card-header d-flex align-items-center justify-content-between">
          ...
          <div class="dropdown">
            <button class="btn btn-text text-body-secondary p-0" type="button" id="referralsList" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Today <i class="icon-base bx bx-chevron-down"></i></button>
        ...
        <div class="card-body text-center">
          <div class="d-flex justify-content-center mb-3">
            <div class="avatar avatar-md flex-shrink-0">
              <span class="avatar-initial avatar-shadow-info rounded-circle"><i class="icon-base bx bx-dollar icon-26px"></i></span>
            </div>
          </div>
    ...
    <div class="col-lg-3 col-md-6 col-sm-6">
      <div class="card">
        <div class="card-header d-flex align-items-center justify-content-between">
          ...
          <div class="dropdown">
            <button class="btn btn-text text-body-secondary p-0" type="button" id="customersList" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Today <i class="icon-base bx bx-chevron-down"></i></button>
        ...
        <div class="card-body text-center">
          <div class="d-flex justify-content-center mb-3">
            <div class="avatar avatar-md flex-shrink-0">
              <span class="avatar-initial avatar-shadow-success rounded-circle"><i class="icon-base bx bx-user icon-26px"></i></span>
            </div>
          </div>
    ...
    <div class="col-lg-3 col-md-6 col-sm-6">
      <div class="card">
        <div class="card-header d-flex align-items-center justify-content-between">
          ...
          <div class="dropdown">
            <button class="btn btn-text text-body-secondary p-0" type="button" id="orderReceivedList" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Today <i class="icon-base bx bx-chevron-down"></i></button>
        ...
        <div class="card-body text-center">
          <div class="d-flex justify-content-center mb-3">
            <div class="avatar avatar-md flex-shrink-0">
              <span class="avatar-initial avatar-shadow-warning rounded-circle"><i class="icon-base bx bx-archive icon-26px"></i></span>
            </div>
          </div>
