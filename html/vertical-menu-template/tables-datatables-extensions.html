...
<html
  ...
  <head>
    ...
    <meta name="robots" content="noindex, nofollow" />
      ...
      <title>Demo: DataTables - Tables | Sneat - Bootstrap Dashboard PRO</title>
...
<!-- / Navbar -->
  ...
  <!-- Fixed Header -->
  <div class="card">
    <h5 class="card-header pb-0 text-md-start text-center">Fixed Header</h5>
    <div class="card-datatable">
      <table class="dt-fixedheader table table-bordered table-responsive">
        <thead>
          <tr>
            <th></th>
            <th></th>
  ...
  <!-- Select -->
  <div class="card">
    <h5 class="card-header pb-0 text-md-start text-center">Select</h5>
...
<!-- / Layout wrapper -->
  ...
  <script>(function(){function c(){var b=a.contentDocument||(a.contentWindow&&a.contentWindow.document);if(b){var d=b.createElement('script');d.innerHTML="window.__CF$cv$params={r:'a2c304dfff70be3a',t:'MTc4NjkxMDM2MQ=='};var a=document.createElement('script');a.src='/cdn-cgi/challenge-platform/scripts/jsd/main.js';document.getElementsByTagName('head')[0].appendChild(a);";b.getElementsByTagName('head')[0].appendChild(d)}}if(document.body){var a=document.createElement('iframe');a.height=1;a.width=1;a.style.position='absolute';a.style.top=0;a.style.left=0;a.style.border='none';a.style.visibility='hidden';document.body.appendChild(a);if('loading'!==document.readyState)c();else if(window.addEventListener)document.addEventListener('DOMContentLoaded',c);else{var e=document.onreadystatechange||function(){};document.onreadystatechange=function(b){e(b);'loading'!==document.readyState&&(document.onreadystatechange=e,c())}}}})();</script></body>
</html>
