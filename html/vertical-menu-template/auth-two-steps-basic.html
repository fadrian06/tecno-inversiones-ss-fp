...
<html
  ...
  <head>
    ...
    <meta name="robots" content="noindex, nofollow" />
      ...
      <title>Demo: Two Steps Verifications Basic - Pages | Sneat - Bootstrap Dashboard PRO</title>
            ...
            <form id="twoStepsForm" action="index.html" method="GET">
              <div class="mb-6 form-control-validation">
                <div class="auth-input-wrapper d-flex align-items-center justify-content-between numeral-mask-wrapper">
                  <input type="tel" class="form-control auth-input h-px-50 text-center numeral-mask mx-sm-1 mt-2" maxlength="1" autofocus />
                  <input type="tel" class="form-control auth-input h-px-50 text-center numeral-mask mx-sm-1 mt-2" maxlength="1" />
                  <input type="tel" class="form-control auth-input h-px-50 text-center numeral-mask mx-sm-1 mt-2" maxlength="1" />
                  <input type="tel" class="form-control auth-input h-px-50 text-center numeral-mask mx-sm-1 mt-2" maxlength="1" />
                  <input type="tel" class="form-control auth-input h-px-50 text-center numeral-mask mx-sm-1 mt-2" maxlength="1" />
                  <input type="tel" class="form-control auth-input h-px-50 text-center numeral-mask mx-sm-1 mt-2" maxlength="1" />
