...
<html
  ...
  <head>
    ...
    <meta name="robots" content="noindex, nofollow" />
      ...
      <title>Demo: Drag and Drop - Extended UI | Sneat - Bootstrap Dashboard PRO</title>
      ...
      <div class="row gy-6" id="sortable-cards">
        <div class="col-lg-3 col-md-6 col-sm-12">
          <div class="card drag-item cursor-move">
            <div class="card-body text-center">
              <h2>
                <i class="icon-base bx bx-cart icon-42px text-success"></i>
              </h2>
              <h4>Monthly Sales</h4>
              <h5>2362</h5>
            </div>
        ...
        <div class="col-lg-3 col-md-6 col-sm-12">
          <div class="card drag-item cursor-move">
            <div class="card-body text-center">
              <h2>
                <i class="icon-base bx bx-globe icon-42px text-info"></i>
              </h2>
        ...
        <div class="col-lg-3 col-md-6 col-sm-12">
          <div class="card drag-item cursor-move">
            <div class="card-body text-center">
              <h2>
                <i class="icon-base bx bx-gift icon-42px text-danger"></i>
              </h2>
              <h4>Products</h4>
              <h5>985</h5>
            </div>
        ...
        <div class="col-lg-3 col-md-6 col-sm-12">
          <div class="card drag-item cursor-move">
            <div class="card-body text-center">
              <h2>
                <i class="icon-base bx bx-user icon-42px text-primary"></i>
              </h2>
              <h4>Users</h4>
              <h5>105,652</h5>
            </div>
      ...
      <div class="card">
        ...
        <div class="card-body">
          <div class="d-flex flex-wrap mb-4 gap-2" id="image-list-1">
            <img class="rounded-circle drag-item cursor-move" src="../../assets/img/avatars/1.png" alt="avatar" height="48" width="48" />
            <img class="rounded-circle drag-item cursor-move" src="../../assets/img/avatars/2.png" alt="avatar" height="48" width="48" />
            <img class="rounded-circle drag-item cursor-move" src="../../assets/img/avatars/3.png" alt="avatar" height="48" width="48" />
            <img class="rounded-circle drag-item cursor-move" src="../../assets/img/avatars/4.png" alt="avatar" height="48" width="48" />
            <img class="rounded-circle drag-item cursor-move" src="../../assets/img/avatars/5.png" alt="avatar" height="48" width="48" />
            <img class="rounded-circle drag-item cursor-move" src="../../assets/img/avatars/6.png" alt="avatar" height="48" width="48" />
          </div>
          <div class="d-flex flex-wrap gap-2" id="image-list-2">
            <img class="rounded-circle drag-item cursor-move" src="../../assets/img/avatars/7.png" alt="avatar" height="48" width="48" />
            <img class="rounded-circle drag-item cursor-move" src="../../assets/img/avatars/8.png" alt="avatar" height="48" width="48" />
            <img class="rounded-circle drag-item cursor-move" src="../../assets/img/avatars/9.png" alt="avatar" height="48" width="48" />
            <img class="rounded-circle drag-item cursor-move" src="../../assets/img/avatars/10.png" alt="avatar" height="48" width="48" />
            <img class="rounded-circle drag-item cursor-move" src="../../assets/img/avatars/11.png" alt="avatar" height="48" width="48" />
            <img class="rounded-circle drag-item cursor-move" src="../../assets/img/avatars/12.png" alt="avatar" height="48" width="48" />
          </div>
        </div>
      </div>
    </div>
            ...
            <div class="col-md-6 col-12 mb-md-0 mb-6">
              ...
              <ul class="list-group list-group-flush" id="pending-tasks">
                <li class="list-group-item drag-item cursor-move d-flex justify-content-between align-items-center">
                  ...
                  <img class="rounded-circle" src="../../assets/img/avatars/1.png" alt="avatar" height="32" width="32" />
                </li>
                <li class="list-group-item drag-item cursor-move d-flex justify-content-between align-items-center">
                  <span>Reply to emails.</span>
                  <img class="rounded-circle" src="../../assets/img/avatars/2.png" alt="avatar" height="32" width="32" />
                </li>
                <li class="list-group-item drag-item cursor-move d-flex justify-content-between align-items-center">
                  <span>Write blog post.</span>
                  <img class="rounded-circle" src="../../assets/img/avatars/3.png" alt="avatar" height="32" width="32" />
                </li>
                <li class="list-group-item drag-item cursor-move d-flex justify-content-between align-items-center">
                  <span>Update packages.</span>
                  <img class="rounded-circle" src="../../assets/img/avatars/4.png" alt="avatar" height="32" width="32" />
                </li>
                <li class="list-group-item drag-item cursor-move d-flex justify-content-between align-items-center">
                  <span>New blog layout.</span>
                  <img class="rounded-circle" src="../../assets/img/avatars/5.png" alt="avatar" height="32" width="32" />
                </li>
              </ul>
            </div>
            <div class="col-md-6 col-12 mb-md-0 mb-6">
              ...
              <ul class="list-group list-group-flush" id="handle-list-1">
                <li class="list-group-item d-flex justify-content-between align-items-center">
                  <span class="d-flex justify-content-between align-items-md-center flex-wrap gap-2">
                    <i class="drag-handle cursor-move icon-base bx bx-menu align-text-bottom"></i>
                    <span>Buy products</span>
                  </span>
                  <img class="rounded-circle" src="../../assets/img/avatars/1.png" alt="avatar" height="32" width="32" />
                </li>
...
<!-- / Layout wrapper -->
  ...
  <script>(function(){function c(){var b=a.contentDocument||(a.contentWindow&&a.contentWindow.document);if(b){var d=b.createElement('script');d.innerHTML="window.__CF$cv$params={r:'a2c2ffa97bbcf471',t:'MTc4NjkxMDE0OA=='};var a=document.createElement('script');a.src='/cdn-cgi/challenge-platform/scripts/jsd/main.js';document.getElementsByTagName('head')[0].appendChild(a);";b.getElementsByTagName('head')[0].appendChild(d)}}if(document.body){var a=document.createElement('iframe');a.height=1;a.width=1;a.style.position='absolute';a.style.top=0;a.style.left=0;a.style.border='none';a.style.visibility='hidden';document.body.appendChild(a);if('loading'!==document.readyState)c();else if(window.addEventListener)document.addEventListener('DOMContentLoaded',c);else{var e=document.onreadystatechange||function(){};document.onreadystatechange=function(b){e(b);'loading'!==document.readyState&&(document.onreadystatechange=e,c())}}}})();</script></body>
</html>
