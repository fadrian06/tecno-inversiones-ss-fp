...
<html
  ...
  <head>
    ...
    <meta name="robots" content="noindex, nofollow" />
      ...
      <title>Demo: Alerts - UI elements | Sneat - Bootstrap Dashboard PRO</title>
  ...
  <div class="row g-6 mb-6">
    ...
    <div class="col-md">
      <div class="card">
        ...
        <div class="card-body">
          <div class="alert alert-solid-primary" role="alert">This is a primary solid alert — check it out!</div>

          <div class="alert alert-solid-secondary" role="alert">This is a secondary solid alert — check it out!</div>

          <div class="alert alert-solid-success" role="alert">This is a success solid alert — check it out!</div>

          <div class="alert alert-solid-danger" role="alert">This is a danger solid alert — check it out!</div>

          <div class="alert alert-solid-warning" role="alert">This is a warning solid alert — check it out!</div>

          <div class="alert alert-solid-info" role="alert">This is an info solid alert — check it out!</div>

          <div class="alert alert-solid-dark mb-0" role="alert">This is a dark solid alert — check it out!</div>
        </div>
      </div>
    </div>
    <!--/ Solid Alerts -->
  ...
  <div class="row g-6">
    ...
    <div class="col-md">
      <div class="card">
        ...
        <div class="card-body">
          <div class="alert alert-primary alert-dismissible" role="alert">
            <h5 class="alert-heading d-flex align-items-center flex-wrap gap-1 mb-1">For a watch</h5>
            <p class="mb-0">Bonbon sweet roll dragée lemon drops tart.</p>
            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
          </div>
          <div class="alert alert-secondary alert-dismissible" role="alert">
            <h5 class="alert-heading d-flex align-items-center flex-wrap gap-1 mb-1">Alert Heading</h5>
          ...
          <div class="alert alert-success alert-dismissible" role="alert">
            <h4 class="alert-heading d-flex align-items-center flex-wrap gap-1">
              <span class="alert-icon rounded-circle"><i class="icon-base bx bx-coffee"></i></span>Well done :)
            </h4>
            <hr />
            <p class="mb-0">Halvah cheesecake toffee. Cupcake jelly cookie chocolate bar topping. Cupcake candy dessert biscuit chocolate halvah bear claw sweet liquorice. Gummies wafer candy canes chocolate.</p>
            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
          </div>
          <div class="alert alert-danger alert-dismissible" role="alert">
            <h4 class="alert-heading d-flex align-items-center flex-wrap gap-1">
            ...
            <p>Aww yeah, you successfully read this important alert message. Sweet muffin croissant oat cake marzipan powder jujubes.</p>
            <hr />
            <p class="mb-0">Whenever you need to, be sure to use margin utilities to keep things nice and tidy.Jujubes bonbon danish dragée oat cake cupcake macaroon. Sesame snaps pudding cotton candy.</p>
            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
          </div>
          <div class="alert alert-primary alert-dismissible mb-0" role="alert">
            <h4 class="alert-heading d-flex align-items-center flex-wrap gap-1">
              <span class="alert-icon rounded-circle"><i class="icon-base bx bx-show"></i></span>For a watch
            </h4>
            <p class="mb-0">Bonbon sweet roll dragée lemon drops tart gummi bears fruitcake. Jujubes bonbon danish dragée oat cake cupcake macaroon. Sesame snaps pudding cotton candy.</p>
            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
          </div>
        </div>
      </div>
    ...
    <div class="col-md">
      <div class="card">
        ...
        <div class="card-body">
          <div class="alert alert-solid-primary d-flex align-items-center flex-wrap gap-1" role="alert">
            <span class="alert-icon rounded-circle">
              <i class="icon-base bx bx-command icon-sm"></i>
            </span>
            This is a primary solid alert — check it out!
          </div>

          <div class="alert alert-solid-secondary d-flex align-items-center flex-wrap gap-1" role="alert">
            <span class="alert-icon rounded-circle">
              <i class="icon-base bx bx-envelope icon-sm"></i>
            </span>
            This is a secondary solid alert — check it out!
          </div>

          <div class="alert alert-solid-success d-flex align-items-center flex-wrap gap-1" role="alert">
            <span class="alert-icon rounded-circle">
              <i class="icon-base bx bx-desktop icon-sm"></i>
            </span>
            This is a success solid alert — check it out!
          </div>

          <div class="alert alert-solid-danger d-flex align-items-center flex-wrap gap-1" role="alert">
            <span class="alert-icon rounded-circle">
              <i class="icon-base bx bx-store icon-sm"></i>
            </span>
            This is a danger solid alert — check it out!
          </div>

          <div class="alert alert-solid-warning d-flex align-items-center flex-wrap gap-1" role="alert">
            <span class="alert-icon rounded-circle">
              <i class="icon-base bx bx-wallet icon-sm"></i>
            </span>
            This is a warning solid alert — check it out!
          </div>

          <div class="alert alert-solid-info d-flex align-items-center flex-wrap gap-1" role="alert">
            <span class="alert-icon rounded-circle">
              <i class="icon-base bx bx-detail icon-sm"></i>
            </span>
            This is an info solid alert — check it out!
          </div>

          <div class="alert alert-solid-dark d-flex align-items-center flex-wrap gap-1 mb-0" role="alert">
            <span class="alert-icon rounded-circle">
...
<!-- / Layout wrapper -->
  ...
  <script>(function(){function c(){var b=a.contentDocument||(a.contentWindow&&a.contentWindow.document);if(b){var d=b.createElement('script');d.innerHTML="window.__CF$cv$params={r:'a2c2fcf74e722150',t:'MTc4NjkxMDAzNw=='};var a=document.createElement('script');a.src='/cdn-cgi/challenge-platform/scripts/jsd/main.js';document.getElementsByTagName('head')[0].appendChild(a);";b.getElementsByTagName('head')[0].appendChild(d)}}if(document.body){var a=document.createElement('iframe');a.height=1;a.width=1;a.style.position='absolute';a.style.top=0;a.style.left=0;a.style.border='none';a.style.visibility='hidden';document.body.appendChild(a);if('loading'!==document.readyState)c();else if(window.addEventListener)document.addEventListener('DOMContentLoaded',c);else{var e=document.onreadystatechange||function(){};document.onreadystatechange=function(b){e(b);'loading'!==document.readyState&&(document.onreadystatechange=e,c())}}}})();</script></body>
</html>
