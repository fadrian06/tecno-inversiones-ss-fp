...
<html
  ...
  <head>
    ...
    <meta name="robots" content="noindex, nofollow" />
      ...
      <title>Demo: Academy - My Courses - App | Sneat - Bootstrap Dashboard PRO</title>
      ...
      <div class="accordion stick-top accordion-custom-button" id="courseContent">
        ...
        <div class="accordion-item">
          ...
          <div id="chapterTwo" class="accordion-collapse collapse" data-bs-parent="#courseContent">
            <div class="accordion-body py-4">
              <div class="form-check mb-4">
                <input class="form-check-input mt-3" type="checkbox" id="defCheck1" checked="" />
              ...
              <div class="form-check mb-4">
                <input class="form-check-input mt-3" type="checkbox" id="defCheck2" />
              ...
              <div class="form-check mb-4">
                <input class="form-check-input mt-3" type="checkbox" id="defCheck3" />
              ...
              <div class="form-check mb-0">
                <input class="form-check-input mt-3" type="checkbox" id="defCheck4" />
        ...
        <div class="accordion-item">
          ...
          <div id="chapterThree" class="accordion-collapse collapse" data-bs-parent="#courseContent">
            <div class="accordion-body py-4">
              <div class="form-check mb-4">
                <input class="form-check-input mt-3" type="checkbox" id="defCheck-01" />
              ...
              <div class="form-check mb-4">
                <input class="form-check-input mt-3" type="checkbox" id="defCheck-02" />
              ...
              <div class="form-check mb-4">
                <input class="form-check-input mt-3" type="checkbox" id="defCheck-03" />
              ...
              <div class="form-check mb-4">
                <input class="form-check-input mt-3" type="checkbox" id="defCheck-04" />
              ...
              <div class="form-check mb-4">
                <input class="form-check-input mt-3" type="checkbox" id="defCheck-05" />
              ...
              <div class="form-check mb-0">
                <input class="form-check-input mt-3" type="checkbox" id="defCheck-06" />
        ...
        <div class="accordion-item">
          ...
          <div id="chapterFour" class="accordion-collapse collapse" data-bs-parent="#courseContent">
            <div class="accordion-body py-4">
              <div class="form-check mb-4">
                <input class="form-check-input mt-3" type="checkbox" id="defCheck-101" checked="" />
              ...
              <div class="form-check mb-4">
                <input class="form-check-input mt-3" type="checkbox" id="defCheck-102" checked="" />
              ...
              <div class="form-check mb-0">
                <input class="form-check-input mt-3" type="checkbox" id="defCheck-103" />
