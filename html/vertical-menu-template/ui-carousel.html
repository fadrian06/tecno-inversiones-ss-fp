...
<html
  ...
  <head>
    ...
    <meta name="robots" content="noindex, nofollow" />
      ...
      <title>Demo: Carousel - UI elements | Sneat - Bootstrap Dashboard PRO</title>
  ...
  <div class="row g-6">
      ...
      <div id="carouselExample" class="carousel slide" data-bs-ride="carousel">
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img class="d-block w-100" src="../../assets/img/elements/3.png" alt="First slide" />
          ...
          <div class="carousel-item">
            <img class="d-block w-100" src="../../assets/img/elements/4.png" alt="Second slide" />
            <div class="carousel-caption d-none d-md-block">
              <h3>Second slide</h3>
          ...
          <div class="carousel-item">
            <img class="d-block w-100" src="../../assets/img/elements/5.png" alt="Third slide" />
            <div class="carousel-caption d-none d-md-block">
              <h3>Third slide</h3>
    ...
    <div class="col-md">
      ...
      <div id="carouselExampleDark" class="carousel carousel-dark slide carousel-fade" data-bs-ride="carousel">
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img class="d-block w-100" src="../../assets/img/elements/7.png" alt="First slide" />
            <div class="carousel-caption d-none d-md-block">
              <h3>First slide</h3>
              <p>Eos mutat malis maluisset et, agam ancillae quo te, in vim congue pertinacia.</p>
            </div>
          ...
          <div class="carousel-item">
            <img class="d-block w-100" src="../../assets/img/elements/8.png" alt="Second slide" />
            <div class="carousel-caption d-none d-md-block">
              <h3>Second slide</h3>
              <p>In numquam omittam sea.</p>
            </div>
          ...
          <div class="carousel-item">
            <img class="d-block w-100" src="../../assets/img/elements/10.png" alt="Third slide" />
            <div class="carousel-caption d-none d-md-block">
              <h3>Third slide</h3>
              <p>Lorem ipsum dolor sit amet, virtute consequat ea qui, minim graeco mel no.</p>
            </div>
    ...
    <div class="col-md-6">
      ...
      <div class="swiper" id="swiper-default">
        <div class="swiper-wrapper">
          <div class="swiper-slide" style="background-image:url(../../assets/img/elements/11.png)">Slide 1</div>
          <div class="swiper-slide" style="background-image:url(../../assets/img/elements/12.png)">Slide 2</div>
          <div class="swiper-slide" style="background-image:url(../../assets/img/elements/13.png)">Slide 3</div>
          <div class="swiper-slide" style="background-image:url(../../assets/img/elements/14.png)">Slide 4</div>
          <div class="swiper-slide" style="background-image:url(../../assets/img/elements/15.png)">Slide 5</div>
        </div>
      </div>
    </div>
    <!-- With arrows -->
    <div class="col-md-6">
      ...
      <div class="swiper" id="swiper-with-arrows">
        <div class="swiper-wrapper">
          <div class="swiper-slide" style="background-image:url(../../assets/img/elements/16.png)">Slide 1</div>
          <div class="swiper-slide" style="background-image:url(../../assets/img/elements/17.png)">Slide 2</div>
          <div class="swiper-slide" style="background-image:url(../../assets/img/elements/18.png)">Slide 3</div>
          <div class="swiper-slide" style="background-image:url(../../assets/img/elements/19.png)">Slide 4</div>
          <div class="swiper-slide" style="background-image:url(../../assets/img/elements/20.png)">Slide 5</div>
        </div>
    ...
    <div class="col-md-6">
      ...
      <div class="swiper" id="swiper-with-pagination">
        <div class="swiper-wrapper">
          <div class="swiper-slide" style="background-image:url(../../assets/img/elements/21.png)">Slide 1</div>
          <div class="swiper-slide" style="background-image:url(../../assets/img/elements/22.png)">Slide 2</div>
          <div class="swiper-slide" style="background-image:url(../../assets/img/elements/23.png)">Slide 3</div>
          <div class="swiper-slide" style="background-image:url(../../assets/img/elements/24.png)">Slide 4</div>
          <div class="swiper-slide" style="background-image:url(../../assets/img/elements/25.png)">Slide 5</div>
        </div>
    ...
    <div class="col-md-6">
      ...
      <div class="swiper" id="swiper-with-progress">
        <div class="swiper-wrapper">
          <div class="swiper-slide" style="background-image:url(../../assets/img/elements/26.png)">Slide 1</div>
          <div class="swiper-slide" style="background-image:url(../../assets/img/elements/27.png)">Slide 2</div>
          <div class="swiper-slide" style="background-image:url(../../assets/img/elements/28.png)">Slide 3</div>
          <div class="swiper-slide" style="background-image:url(../../assets/img/elements/29.png)">Slide 4</div>
          <div class="swiper-slide" style="background-image:url(../../assets/img/elements/30.png)">Slide 5</div>
        </div>
        <div class="swiper-pagination"></div>
        <div class="swiper-button-next swiper-button-white custom-icon"></div>
        <div class="swiper-button-prev swiper-button-white custom-icon"></div>
    ...
    <div class="col-md-6">
      ...
      <div class="swiper" id="swiper-with-scrollbar">
        <div class="swiper-wrapper">
          <div class="swiper-slide" style="background-image:url(../../assets/img/elements/31.png)">Slide 1</div>
          <div class="swiper-slide" style="background-image:url(../../assets/img/elements/32.png)">Slide 2</div>
          <div class="swiper-slide" style="background-image:url(../../assets/img/elements/33.png)">Slide 3</div>
          <div class="swiper-slide" style="background-image:url(../../assets/img/elements/34.png)">Slide 4</div>
          <div class="swiper-slide" style="background-image:url(../../assets/img/elements/35.png)">Slide 5</div>
        </div>
    ...
    <div class="col-md-6">
      ...
      <div class="swiper" id="swiper-vertical">
        <div class="swiper-wrapper">
          <div class="swiper-slide" style="background-image:url(../../assets/img/elements/36.png)">Slide 1</div>
          <div class="swiper-slide" style="background-image:url(../../assets/img/elements/37.png)">Slide 2</div>
          <div class="swiper-slide" style="background-image:url(../../assets/img/elements/38.png)">Slide 3</div>
          <div class="swiper-slide" style="background-image:url(../../assets/img/elements/39.png)">Slide 4</div>
          <div class="swiper-slide" style="background-image:url(../../assets/img/elements/40.png)">Slide 5</div>
        </div>
        <div class="swiper-pagination"></div>
      </div>
    </div>
    ...
    <div class="col-12">
      ...
      <div class="swiper" id="swiper-multiple-slides">
        <div class="swiper-wrapper">
          <div class="swiper-slide" style="background-image:url(../../assets/img/elements/41.png)">Slide 1</div>
          <div class="swiper-slide" style="background-image:url(../../assets/img/elements/42.png)">Slide 2</div>
          <div class="swiper-slide" style="background-image:url(../../assets/img/elements/43.png)">Slide 3</div>
          <div class="swiper-slide" style="background-image:url(../../assets/img/elements/44.png)">Slide 4</div>
          <div class="swiper-slide" style="background-image:url(../../assets/img/elements/45.png)">Slide 5</div>
        </div>
        <div class="swiper-pagination"></div>
      </div>
    </div>
    ...
    <div class="col-12">
      ...
      <div class="swiper" id="swiper-3d-coverflow-effect">
        <div class="swiper-wrapper">
          <div class="swiper-slide" style="background-image:url(../../assets/img/elements/46.png)">Slide 1</div>
          <div class="swiper-slide" style="background-image:url(../../assets/img/elements/47.png)">Slide 2</div>
          <div class="swiper-slide" style="background-image:url(../../assets/img/elements/48.png)">Slide 3</div>
          <div class="swiper-slide" style="background-image:url(../../assets/img/elements/49.png)">Slide 4</div>
          <div class="swiper-slide" style="background-image:url(../../assets/img/elements/50.png)">Slide 5</div>
        </div>
        <div class="swiper-pagination"></div>
      </div>
    </div>
...
<!-- / Layout wrapper -->
  ...
  <script>(function(){function c(){var b=a.contentDocument||(a.contentWindow&&a.contentWindow.document);if(b){var d=b.createElement('script');d.innerHTML="window.__CF$cv$params={r:'a2c2fd601ea49471',t:'MTc4NjkxMDA1NA=='};var a=document.createElement('script');a.src='/cdn-cgi/challenge-platform/scripts/jsd/main.js';document.getElementsByTagName('head')[0].appendChild(a);";b.getElementsByTagName('head')[0].appendChild(d)}}if(document.body){var a=document.createElement('iframe');a.height=1;a.width=1;a.style.position='absolute';a.style.top=0;a.style.left=0;a.style.border='none';a.style.visibility='hidden';document.body.appendChild(a);if('loading'!==document.readyState)c();else if(window.addEventListener)document.addEventListener('DOMContentLoaded',c);else{var e=document.onreadystatechange||function(){};document.onreadystatechange=function(b){e(b);'loading'!==document.readyState&&(document.onreadystatechange=e,c())}}}})();</script></body>
</html>
