...
<html
  ...
  <head>
    ...
    <meta name="robots" content="noindex, nofollow" />
      ...
      <title>Demo: Account settings - Pages | Sneat - Bootstrap Dashboard PRO</title>
          ...
          <div class="col-md-6 col-12">
            ...
            <div class="card-body">
              ...
              <div class="d-flex align-items-center">
                <div class="flex-shrink-0">
                  <img src="../../assets/img/icons/brands/asana.png" alt="asana" class="me-4" height="32" />
                </div>
                <div class="flex-grow-1 d-flex align-items-center justify-content-between">
                  <div class="mb-sm-0 mb-2">
              ...
              <div class="d-flex mb-4 align-items-center">
                ...
                <div class="flex-grow-1 row">
                  ...
                  <div class="col-5 text-end mt-sm-0 mt-2">
                    <button class="btn btn-icon btn-label-secondary"><i class="icon-base bx bx-link icon-md"></i></button>
                  </div>
                </div>
              </div>
              <div class="d-flex mb-4 align-items-center">
                <div class="flex-shrink-0">
                  <img src="../../assets/img/icons/brands/twitter-light.png" alt="twitter" class="me-4" height="32" data-app-dark-img="icons/brands/twitter-dark.png" data-app-light-img="icons/brands/twitter-light.png" />
                </div>
                <div class="flex-grow-1 row">
                  <div class="col-7">
                  ...
                  <div class="col-5 text-end mt-sm-0 mt-2">
                    <button class="btn btn-icon btn-label-danger"><i class="icon-base bx bx-trash icon-md"></i></button>
                  </div>
                </div>
              </div>
              <div class="d-flex mb-4 align-items-center">
...
<!-- / Layout wrapper -->
  ...
  <script>(function(){function c(){var b=a.contentDocument||(a.contentWindow&&a.contentWindow.document);if(b){var d=b.createElement('script');d.innerHTML="window.__CF$cv$params={r:'a2c2eda30debde1b',t:'MTc4NjkwOTQwOQ=='};var a=document.createElement('script');a.src='/cdn-cgi/challenge-platform/scripts/jsd/main.js';document.getElementsByTagName('head')[0].appendChild(a);";b.getElementsByTagName('head')[0].appendChild(d)}}if(document.body){var a=document.createElement('iframe');a.height=1;a.width=1;a.style.position='absolute';a.style.top=0;a.style.left=0;a.style.border='none';a.style.visibility='hidden';document.body.appendChild(a);if('loading'!==document.readyState)c();else if(window.addEventListener)document.addEventListener('DOMContentLoaded',c);else{var e=document.onreadystatechange||function(){};document.onreadystatechange=function(b){e(b);'loading'!==document.readyState&&(document.onreadystatechange=e,c())}}}})();</script></body>
</html>
