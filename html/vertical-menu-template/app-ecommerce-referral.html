...
<html
  ...
  <head>
    ...
    <meta name="robots" content="noindex, nofollow" />
      ...
      <title>Demo: eCommerce Referral - App | Sneat - Bootstrap Dashboard PRO</title>
        ...
        <div class="card-body">
          ...
          <div class="d-flex flex-column flex-sm-row justify-content-between text-center gap-6">
            <div class="d-flex flex-column align-items-center">
              <div class="p-4 border border-primary rounded-circle border-dashed mb-0"><i class="icon-base bx bx-rocket text-primary icon-36px"></i></div>
              <p class="my-2 w-75">Create & validate your referral link and get</p>
              <h6 class="text-primary mb-0">$50</h6>
            </div>
            <div class="d-flex flex-column align-items-center">
              <div class="p-4 border border-primary rounded-circle border-dashed mb-0"><i class="icon-base bx bxs-user-badge text-primary icon-36px"></i></div>
              <p class="my-2 w-75">For every new signup you get</p>
              <h6 class="text-primary mb-0">10%</h6>
            </div>
            <div class="d-flex flex-column align-items-center">
              <div class="p-4 border border-primary rounded-circle border-dashed mb-0"><i class="icon-base bx bxs-paper-plane text-primary icon-36px"></i></div>
          ...
          <form class="referral-form" onsubmit="return false">
            ...
            <div>
              ...
              <div class="d-flex gap-4 align-items-end">
                ...
                <div class="d-flex">
                  <button type="button" class="btn btn-facebook btn-icon me-2"><i class="icon-base bx bxl-facebook icon-md text-white"></i></button>
                  <button type="button" class="btn btn-twitter btn-icon"><i class="icon-base bx bxl-twitter icon-md text-white"></i></button>
                </div>
              </div>
            </div>
          </form>
...
<!-- / Layout wrapper -->
  ...
  <script>(function(){function c(){var b=a.contentDocument||(a.contentWindow&&a.contentWindow.document);if(b){var d=b.createElement('script');d.innerHTML="window.__CF$cv$params={r:'a2c2e77a7fc3d751',t:'MTc4NjkwOTE1Nw=='};var a=document.createElement('script');a.src='/cdn-cgi/challenge-platform/scripts/jsd/main.js';document.getElementsByTagName('head')[0].appendChild(a);";b.getElementsByTagName('head')[0].appendChild(d)}}if(document.body){var a=document.createElement('iframe');a.height=1;a.width=1;a.style.position='absolute';a.style.top=0;a.style.left=0;a.style.border='none';a.style.visibility='hidden';document.body.appendChild(a);if('loading'!==document.readyState)c();else if(window.addEventListener)document.addEventListener('DOMContentLoaded',c);else{var e=document.onreadystatechange||function(){};document.onreadystatechange=function(b){e(b);'loading'!==document.readyState&&(document.onreadystatechange=e,c())}}}})();</script></body>
</html>
