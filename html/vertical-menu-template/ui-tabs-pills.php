...
<html
  ...
  <head>
    ...
    <meta name="robots" content="noindex, nofollow" />
      ...
      <title>Demo: Tabs and pills - UI elements | Sneat - Bootstrap Dashboard PRO</title>
        ...
        <ul class="nav nav-tabs nav-fill" role="tablist">
          ...
          <li class="nav-item">
            <button
              ...
              aria-selected="false">
              <span class="d-none d-sm-inline-flex align-items-center"
                ><i class="icon-base bx bx-user icon-sm me-1_5"></i>Profile</span
              >
          ...
          <li class="nav-item">
            <button
              ...
              aria-selected="false">
              <span class="d-none d-sm-inline-flex align-items-center"
                ><i class="icon-base bx bx-message-square icon-sm me-1_5"></i>Messages</span
              >
        ...
        <ul class="nav nav-tabs" role="tablist">
          <li class="nav-item">
            <button
              ...
              role="tab"
              data-bs-toggle="tab"
              data-bs-target="#navs-bottom-home"
              aria-controls="navs-bottom-home"
              aria-selected="true">
              Home
            </button>
          </li>
          <li class="nav-item">
            <button
              ...
              role="tab"
              data-bs-toggle="tab"
              data-bs-target="#navs-bottom-profile"
              aria-controls="navs-bottom-profile"
              aria-selected="false">
              Profile
            </button>
          </li>
          <li class="nav-item">
            <button
              ...
              role="tab"
              data-bs-toggle="tab"
              data-bs-target="#navs-bottom-messages"
              aria-controls="navs-bottom-messages"
              aria-selected="false">
              Messages
            </button>
          </li>
        ...
        <ul class="nav nav-pills me-4" role="tablist">
          <li class="nav-item">
            <button
              ...
              role="tab"
              data-bs-toggle="tab"
              data-bs-target="#navs-pills-left-home"
        ...
        <div class="card-header">
          <div class="nav-align-top">
            <ul class="nav nav-pills" role="tablist">
              ...
              <li class="nav-item">
                <button type="button" class="nav-link disabled" role="tab" data-bs-toggle="tab" aria-selected="false">
                  Disabled
                </button>
              </li>
            </ul>
...
<!-- / Layout wrapper -->
  ...
  <script>(function(){function c(){var b=a.contentDocument||(a.contentWindow&&a.contentWindow.document);if(b){var d=b.createElement('script');d.innerHTML="window.__CF$cv$params={r:'a2c2fed4ded1187a',t:'MTc4NjkxMDExNA=='};var a=document.createElement('script');a.src='/cdn-cgi/challenge-platform/scripts/jsd/main.js';document.getElementsByTagName('head')[0].appendChild(a);";b.getElementsByTagName('head')[0].appendChild(d)}}if(document.body){var a=document.createElement('iframe');a.height=1;a.width=1;a.style.position='absolute';a.style.top=0;a.style.left=0;a.style.border='none';a.style.visibility='hidden';document.body.appendChild(a);if('loading'!==document.readyState)c();else if(window.addEventListener)document.addEventListener('DOMContentLoaded',c);else{var e=document.onreadystatechange||function(){};document.onreadystatechange=function(b){e(b);'loading'!==document.readyState&&(document.onreadystatechange=e,c())}}}})();</script></body>
</html>
