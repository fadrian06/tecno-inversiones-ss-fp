...
<html
  ...
  <head>
    ...
    <meta name="robots" content="noindex, nofollow" />
      ...
      <title>Demo: Settings Shipping &amp; Delivery - eCommerce | Sneat - Bootstrap Dashboard PRO</title>
      ...
      <div class="tab-content p-0">
        ...
        <div class="tab-pane fade show active" id="shipping_delivery" role="tabpanel">
              ...
              <div class="d-flex justify-content-between align-items-center mb-4">
                <div class="d-flex align-items-center">
                  <div class="avatar avatar-sm me-2">
                    <img class="rounded-circle mb-4" src="../../assets/img/avatars/1.png" height="34" width="34" alt="User avatar" />
                  </div>
                ...
                <div>
                  <a href="javascript:void(0);" class="btn btn-sm btn-icon text-secondary me-1"><i class="icon-base bx bx-pencil icon-20px"></i></a>
                  <a href="javascript:void(0);" class="btn btn-sm btn-icon text-secondary"><i class="icon-base bx bx-trash icon-20px"></i></a>
                </div>
              </div>
                      ...
                      <tr>
                        ...
                        <td class="text-end">
                          <div class="dropdown pe-4">
                            <button type="button" class="btn btn-icon dropdown-toggle hide-arrow" data-bs-toggle="dropdown"><i class="icon-base bx bx-dots-vertical-rounded icon-md"></i></button>
                            <div class="dropdown-menu">
                              <a class="dropdown-item" href="javascript:void(0);"><i class="icon-base bx bx-edit icon-md me-1"></i> Edit</a>
                              <a class="dropdown-item" href="javascript:void(0);"><i class="icon-base bx bx-trash icon-md me-1"></i> Delete</a>
                            </div>
                          </div>
                        </td>
                      </tr>
                      <tr>
                        ...
                        <td class="text-end">
                          <div class="dropdown pe-4">
                            <button type="button" class="btn btn-icon dropdown-toggle hide-arrow" data-bs-toggle="dropdown"><i class="icon-base bx bx-dots-vertical-rounded icon-md"></i></button>
                            <div class="dropdown-menu">
                              <a class="dropdown-item" href="javascript:void(0);"><i class="icon-base bx bx-edit icon-md me-2"></i> Edit</a>
                              <a class="dropdown-item" href="javascript:void(0);"><i class="icon-base bx bx-trash icon-md me-2"></i> Delete</a>
                            </div>
                          </div>
                        </td>
                      </tr>
          ...
          <div class="d-flex justify-content-end gap-4">
            ...
            <a class="btn btn-primary" href="app-ecommerce-settings-locations.html">Save Changes</a>
          </div>
        </div>
      </div>
      <!-- /Options-->
...
<!-- / Layout wrapper -->
  ...
  <script>(function(){function c(){var b=a.contentDocument||(a.contentWindow&&a.contentWindow.document);if(b){var d=b.createElement('script');d.innerHTML="window.__CF$cv$params={r:'a2c2e81eba6d1e01',t:'MTc4NjkwOTE4Mw=='};var a=document.createElement('script');a.src='/cdn-cgi/challenge-platform/scripts/jsd/main.js';document.getElementsByTagName('head')[0].appendChild(a);";b.getElementsByTagName('head')[0].appendChild(d)}}if(document.body){var a=document.createElement('iframe');a.height=1;a.width=1;a.style.position='absolute';a.style.top=0;a.style.left=0;a.style.border='none';a.style.visibility='hidden';document.body.appendChild(a);if('loading'!==document.readyState)c();else if(window.addEventListener)document.addEventListener('DOMContentLoaded',c);else{var e=document.onreadystatechange||function(){};document.onreadystatechange=function(b){e(b);'loading'!==document.readyState&&(document.onreadystatechange=e,c())}}}})();</script></body>
</html>
