...
<html
  ...
  <head>
    ...
    <meta name="robots" content="noindex, nofollow" />
      ...
      <title>Demo: Cards Actions- UI elements | Sneat - Bootstrap Dashboard PRO</title>
...
<!-- / Navbar -->
      ...
      <div class="card-action-element">
        <ul class="list-inline mb-0">
          <li class="list-inline-item">
            <a href="javascript:void(0);" class="card-collapsible"><i class="icon-base bx bx-chevron-up"></i></a>
          </li>
          <li class="list-inline-item">
            <a href="javascript:void(0);" class="card-reload"><i class="icon-base bx bx-rotate-left scaleX-n1-rtl"></i></a>
          </li>
          <li class="list-inline-item">
            <a href="javascript:void(0);" class="card-expand"><i class="icon-base bx bx-fullscreen"></i></a>
          </li>
          <li class="list-inline-item">
            <a href="javascript:void(0);" class="card-close"><i class="icon-base bx bx-x"></i></a>
          </li>
        </ul>
      </div>
    </div>
        ...
        <tbody class="table-border-bottom-0">
          <tr>
            ...
            <td class="text-center">
              <i class="icon-base bx bx-chevron-up"></i>
            </td>
          ...
          <tr>
            ...
            <td class="text-center">
              <i class="icon-base bx bx-rotate-left scaleX-n1-rtl"></i>
            </td>
      ...
      <div class="card card-action mb-6">
        ...
        <div class="collapse show">
          <div class="card-body pt-0">
            ...
            <p class="card-text">Click on <i class="icon-base bx bx-chevron-up"></i> to see card collapse in action.</p>
          </div>
        </div>
      </div>
    </div>
    <div class="col-md">
      <div class="card card-action mb-6">
        ...
        <div class="card-body">
          ...
          <p class="card-text">Click on <i class="icon-base bx bx-rotate-left scaleX-n1-rtl"></i> icon to see refresh card content in action.</p>
        </div>
      </div>
    </div>
    <div class="w-100"></div>
    <div class="col-md">
      <div class="card card-action mb-6">
        ...
        <div class="card-body">
          ...
          <p class="card-text">Click on <i class="icon-base bx bx-fullscreen"></i> icon to see expand card in action.</p>
        </div>
      </div>
    </div>
    <div class="col-md">
      <div class="card card-action mb-6">
        ...
        <div class="card-body">
          ...
          <br />
          <p class="card-text">Click on <i class="icon-base bx bx-x"></i> icon to see remove card in action.</p>
        </div>
      </div>
    </div>
  </div>
  ...
  <!-- Header elements -->
  <h5 class="pb-1 mb-6">Header Elements</h5>
  <div class="row mb-12 gx-6">
    <div class="col-md">
      <div class="card mb-6">
    ...
    <div class="col-md">
      <div class="card mb-6">
        <div class="card-header header-elements">
          ...
          <div class="card-header-elements ms-auto">
            <button type="button" class="btn btn-xs btn-primary"><span class="icon-base bx bx-plus icon-xs me-1"></span>Button</button>
          </div>
        </div>
        <div class="card-body">
          ...
          <div class="card-title header-elements">
            ...
            <div class="card-title-elements ms-auto">
              <button type="button" class="btn btn-icon btn-sm btn-primary">
                <span class="icon-base bx bx-shopping-bag icon-20px"></span>
              </button>
            </div>
          </div>
    ...
    <div class="col-md">
      <div class="card mb-6">
        <div class="card-header header-elements">
          <h5 class="mb-0 me-2">Card Header</h5>
          <div class="card-header-elements ms-auto">
            <span class="icon-base bx bx-bell text-body-secondary"></span>
  ...
  <div class="row gy-6" id="sortable-4">
...
<!-- / Layout wrapper -->
  ...
  <script>(function(){function c(){var b=a.contentDocument||(a.contentWindow&&a.contentWindow.document);if(b){var d=b.createElement('script');d.innerHTML="window.__CF$cv$params={r:'a2c2fca93e000b17',t:'MTc4NjkxMDAyNQ=='};var a=document.createElement('script');a.src='/cdn-cgi/challenge-platform/scripts/jsd/main.js';document.getElementsByTagName('head')[0].appendChild(a);";b.getElementsByTagName('head')[0].appendChild(d)}}if(document.body){var a=document.createElement('iframe');a.height=1;a.width=1;a.style.position='absolute';a.style.top=0;a.style.left=0;a.style.border='none';a.style.visibility='hidden';document.body.appendChild(a);if('loading'!==document.readyState)c();else if(window.addEventListener)document.addEventListener('DOMContentLoaded',c);else{var e=document.onreadystatechange||function(){};document.onreadystatechange=function(b){e(b);'loading'!==document.readyState&&(document.onreadystatechange=e,c())}}}})();</script></body>
</html>
