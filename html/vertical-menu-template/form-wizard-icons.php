...
<html
  ...
  <head>
    ...
    <meta name="robots" content="noindex, nofollow" />
      ...
      <title>Demo: Wizard Icons - Forms | Sneat - Bootstrap Dashboard PRO</title>
    ...
    <div class="col-12 mb-6">
      ...
      <div class="bs-stepper wizard-icons wizard-icons-example mt-2">
        <div class="bs-stepper-header">
          ...
          <div class="line">
            <i class="icon-base bx bx-right-arrow-alt icon-md scaleX-n1-rtl"></i>
          </div>
          ...
          <form onSubmit="return false">
              ...
              <div class="row g-6">
                ...
                <div class="col-12 d-flex justify-content-between">
                  ...
                  <button class="btn btn-primary btn-next">
                    ...
                    <i class="icon-base bx bx-right-arrow-alt icon-sm scaleX-n1-rtl me-sm-n2"></i>
                  </button>
                </div>
              </div>
            </div>
            ...
            <div id="review-submit" class="content">
              ...
              <ul class="list-unstyled">
                <li>Username</li>
                <li><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="a0c5d8c1cdd0cce0c5cdc1c9cc8ec3cfcd">[email&#160;protected]</a></li>
              </ul>
              <hr />
              ...
              <div class="row g-6">
                ...
                <div class="col-sm-6 form-password-toggle">
                  ...
                  <div class="input-group input-group-merge">
                    ...
                    <span class="input-group-text cursor-pointer" id="password6"><i class="icon-base bx bx-hide"></i></span>
                  </div>
                </div>
                <div class="col-sm-6 form-password-toggle">
                  ...
                  <div class="input-group input-group-merge">
                    ...
                    <span class="input-group-text cursor-pointer" id="confirm-password7"><i class="icon-base bx bx-hide"></i></span>
                  </div>
                </div>
                <div class="col-12 d-flex justify-content-between">
                  <button class="btn btn-label-secondary btn-prev" disabled>
        ...
        <div class="bs-stepper-content">
          <form onSubmit="return false">
              ...
              <div class="row g-6">
                ...
                <div class="col-sm-6 form-password-toggle">
                  ...
                  <div class="input-group input-group-merge">
                    ...
                    <span class="input-group-text cursor-pointer" id="confirm-password2-modern"><i class="icon-base bx bx-hide"></i></span>
                  </div>
                </div>
                <div class="col-12 d-flex justify-content-between">
                  <button class="btn btn-label-secondary btn-prev" disabled>
            ...
            <div id="review-submit-modern" class="content">
              ...
              <ul class="list-unstyled">
                <li>Username</li>
                <li><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="6d08150c001d012d08000c0401430e0200">[email&#160;protected]</a></li>
              </ul>
              <hr />
              <p class="fw-medium mb-2">Personal Info</p>
              <ul class="list-unstyled">
              ...
              <div class="row g-6">
                ...
                <div class="col-sm-6 form-password-toggle">
                  ...
                  <div class="input-group input-group-merge">
                    ...
                    <span class="input-group-text cursor-pointer" id="password-modern-vertical1"><i class="icon-base bx bx-hide"></i></span>
                  </div>
                </div>
                <div class="col-sm-6 form-password-toggle">
                  ...
                  <div class="input-group input-group-merge">
                    ...
                    <span class="input-group-text cursor-pointer" id="confirm-password-modern-vertical3"><i class="icon-base bx bx-hide"></i></span>
                  </div>
                </div>
                <div class="col-12 d-flex justify-content-between">
                  <button class="btn btn-label-secondary btn-prev" disabled>
...
<!-- / Layout wrapper -->
  ...
  <script>(function(){function c(){var b=a.contentDocument||(a.contentWindow&&a.contentWindow.document);if(b){var d=b.createElement('script');d.innerHTML="window.__CF$cv$params={r:'a2c3042a9ec93347',t:'MTc4NjkxMDMzMg=='};var a=document.createElement('script');a.src='/cdn-cgi/challenge-platform/scripts/jsd/main.js';document.getElementsByTagName('head')[0].appendChild(a);";b.getElementsByTagName('head')[0].appendChild(d)}}if(document.body){var a=document.createElement('iframe');a.height=1;a.width=1;a.style.position='absolute';a.style.top=0;a.style.left=0;a.style.border='none';a.style.visibility='hidden';document.body.appendChild(a);if('loading'!==document.readyState)c();else if(window.addEventListener)document.addEventListener('DOMContentLoaded',c);else{var e=document.onreadystatechange||function(){};document.onreadystatechange=function(b){e(b);'loading'!==document.readyState&&(document.onreadystatechange=e,c())}}}})();</script></body>
</html>
