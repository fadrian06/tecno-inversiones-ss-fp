...
<html
  ...
  <head>
    ...
    <meta name="robots" content="noindex, nofollow" />
      ...
      <title>Demo: eCommerce Manage reviews - App | Sneat - Bootstrap Dashboard PRO</title>
      ...
      <div class="card h-100">
        <div class="card-body row widget-separator g-0">
          <div class="col-sm-5 border-shift border-end pe-sm-6">
            <h3 class="text-primary d-flex align-items-center gap-2 mb-2">4.89<i class="bx bxs-star icon-30px"></i></h3>
