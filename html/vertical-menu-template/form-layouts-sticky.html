...
<html
  ...
  <head>
    ...
    <meta name="robots" content="noindex, nofollow" />
      ...
      <title>Demo: Sticky Actions - Forms | Sneat - Bootstrap Dashboard PRO</title>
                ...
                <div class="form-check custom-option custom-option-icon">
                  <label class="form-check-label custom-option-content" for="customRadioIcon1">
                    <span class="custom-option-body">
                      <i class="icon-base bx bx-briefcase-alt-2"></i>
              ...
              <div class="col-md">
                <div class="form-check custom-option custom-option-icon">
                  <label class="form-check-label custom-option-content" for="customRadioIcon2">
                    <span class="custom-option-body">
                      <i class="icon-base bx bx-paper-plane"></i>
                    ...
                    <div class="col-6 col-md-3">
                      <div class="mb-4">
                        ...
                        <div class="input-group input-group-merge">
                          ...
                          <span class="input-group-text cursor-pointer" id="collapsible-payment-cvv2"><i class="icon-base bx bx-help-circle" data-bs-toggle="tooltip" data-bs-placement="top" title="Card Verification Value"></i></span>
                        </div>
                      </div>
                    </div>
                  </div>
