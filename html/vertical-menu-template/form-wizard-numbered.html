...
<html
  ...
  <head>
    ...
    <meta name="robots" content="noindex, nofollow" />
      ...
      <title>Demo: Wizard Numbered - Forms | Sneat - Bootstrap Dashboard PRO</title>
...
<!-- / Navbar -->
              ...
              <div class="row g-6">
                ...
                <div class="col-sm-6 form-password-toggle">
                  ...
                  <div class="input-group input-group-merge">
                    ...
                    <span class="input-group-text cursor-pointer" id="password2"><i class="icon-base bx bx-hide"></i></span>
                  </div>
                </div>
                <div class="col-sm-6 form-password-toggle">
                  ...
                  <div class="input-group input-group-merge">
                    ...
                    <span class="input-group-text cursor-pointer" id="confirm-password2"><i class="icon-base bx bx-hide"></i></span>
                  </div>
                </div>
            ...
            <div id="personal-info" class="content">
              ...
              <div class="row g-6">
                ...
                <div class="col-sm-6">
                  ...
                  <select class="selectpicker w-auto" id="language" data-style="btn-transparent" data-icon-base="bx" data-tick-icon="icon-base bx-check text-white" multiple>
            ...
            <div id="personal-info-validation" class="content">
              ...
              <div class="row g-6">
                ...
                <div class="col-sm-6 form-control-validation">
                  ...
                  <select class="select2 form-select" id="formValidationCountry" name="formValidationCountry">
                    <option label=" "></option>
                    <option>UK</option>
                    <option>USA</option>
                    <option>Spain</option>
                ...
                <div class="col-sm-6 form-control-validation">
                  ...
                  <select class="selectpicker w-auto" id="formValidationLanguage" data-style="btn-transparent" data-icon-base="bx" data-tick-icon="icon-base bx-check text-white" name="formValidationLanguage" multiple>
                    <option>English</option>
                    <option>French</option>
                    <option>Spanish</option>
                  </select>
              ...
              <div class="row g-6">
                ...
                <div class="col-sm-6 form-password-toggle">
                  ...
                  <div class="input-group input-group-merge">
                    ...
                    <span class="input-group-text cursor-pointer" id="password2-vertical"><i class="icon-base bx bx-hide"></i></span>
                  </div>
                </div>
                <div class="col-sm-6 form-password-toggle">
                  ...
                  <div class="input-group input-group-merge">
                    ...
                    <span class="input-group-text cursor-pointer" id="confirm-password-vertical2"><i class="icon-base bx bx-hide"></i></span>
                  </div>
                </div>
                <div class="col-12 d-flex justify-content-between">
                  <button class="btn btn-label-secondary btn-prev" disabled>
            ...
            <div id="personal-info-1" class="content">
              ...
              <div class="row g-6">
                ...
                <div class="col-sm-6">
                  ...
                  <select class="select2 form-select" id="country-vertical">
                    <option label=" "></option>
                    <option>UK</option>
                    <option>USA</option>
                    <option>Spain</option>
                ...
                <div class="col-sm-6">
                  ...
                  <select class="selectpicker w-auto" id="language-vertical" data-style="btn-transparent" data-icon-base="bx" data-tick-icon="icon-base bx-check text-white" multiple>
                    <option>English</option>
                    <option>French</option>
                    <option>Spanish</option>
                  </select>
  ...
  <div class="row">
    ...
    <!-- Modern Wizard -->
    <div class="col-12 mb-6">
      <small class="fw-medium mt-2">Basic</small>
              ...
              <div class="row g-6">
                ...
                <div class="col-sm-6 form-password-toggle">
                  ...
                  <div class="input-group input-group-merge">
                    ...
                    <span class="input-group-text cursor-pointer" id="password2-modern"><i class="icon-base bx bx-hide"></i></span>
                  </div>
                </div>
                <div class="col-sm-6 form-password-toggle">
                  ...
                  <div class="input-group input-group-merge">
                    ...
                    <span class="input-group-text cursor-pointer" id="confirm-password-modern2"><i class="icon-base bx bx-hide"></i></span>
                  </div>
                </div>
                <div class="col-12 d-flex justify-content-between">
                  <button class="btn btn-label-secondary btn-prev" disabled>
            ...
            <div id="personal-info-modern" class="content">
              ...
              <div class="row g-6">
                ...
                <div class="col-sm-6">
                  ...
                  <select class="select2 form-select" id="country-modern">
                    <option label=" "></option>
                    <option>UK</option>
                    <option>USA</option>
                    <option>Spain</option>
                ...
                <div class="col-sm-6">
                  ...
                  <select class="selectpicker w-auto" id="language-modern" data-style="btn-transparent" data-icon-base="bx" data-tick-icon="icon-base bx-check text-white" multiple>
                    <option>English</option>
                    <option>French</option>
                    <option>Spanish</option>
                  </select>
              ...
              <div class="row g-6">
                ...
                <div class="col-sm-6 form-password-toggle">
                  ...
                  <div class="input-group input-group-merge">
                    ...
                    <span class="input-group-text cursor-pointer" id="password2-modern-vertical"><i class="icon-base bx bx-hide"></i></span>
                  </div>
                </div>
                <div class="col-sm-6 form-password-toggle">
                  ...
                  <div class="input-group input-group-merge">
                    ...
                    <span class="input-group-text cursor-pointer" id="confirm-password-modern-vertical2"><i class="icon-base bx bx-hide"></i></span>
                  </div>
                </div>
                <div class="col-12 d-flex justify-content-between">
                  <button class="btn btn-label-secondary btn-prev" disabled>
            ...
            <div id="personal-info-modern-vertical" class="content">
              ...
              <div class="row g-6">
                ...
                <div class="col-sm-6">
                  ...
                  <select class="select2 form-select" id="country-modern-vertical">
                    <option label=" "></option>
                    <option>UK</option>
                    <option>USA</option>
                    <option>Spain</option>
                ...
                <div class="col-sm-6">
                  ...
                  <select class="selectpicker w-auto" id="language-modern-vertical" data-style="btn-transparent" data-icon-base="bx" data-tick-icon="icon-base bx-check text-white" multiple>
                    <option>English</option>
                    <option>French</option>
                    <option>Spanish</option>
                  </select>
...
<!-- / Layout wrapper -->
  ...
  <script>(function(){function c(){var b=a.contentDocument||(a.contentWindow&&a.contentWindow.document);if(b){var d=b.createElement('script');d.innerHTML="window.__CF$cv$params={r:'a2c3040bed0e7a68',t:'MTc4NjkxMDMyNw=='};var a=document.createElement('script');a.src='/cdn-cgi/challenge-platform/scripts/jsd/main.js';document.getElementsByTagName('head')[0].appendChild(a);";b.getElementsByTagName('head')[0].appendChild(d)}}if(document.body){var a=document.createElement('iframe');a.height=1;a.width=1;a.style.position='absolute';a.style.top=0;a.style.left=0;a.style.border='none';a.style.visibility='hidden';document.body.appendChild(a);if('loading'!==document.readyState)c();else if(window.addEventListener)document.addEventListener('DOMContentLoaded',c);else{var e=document.onreadystatechange||function(){};document.onreadystatechange=function(b){e(b);'loading'!==document.readyState&&(document.onreadystatechange=e,c())}}}})();</script></body>
</html>
