...
<html
  ...
  <head>
    ...
    <meta name="robots" content="noindex, nofollow" />
      ...
      <title>Demo: Muy Pronto - Páginas | Sneat - Bootstrap Dashboard PRO</title>
  ...
  <div class="container-xxl py-4">
    <div class="misc-wrapper">
      <h3 class="mb-2 mx-2">Estamos lanzando pronto 🚀</h3>
      <p class="mb-6 mx-2">Nuestro sitio web se abrirá pronto. ¡Regístrese para recibir una notificación cuando esté listo!!</p>
      <?php dump(flash()->display()) ?>
      <form method="post">
        <div>
          <div class="mb-1 d-flex gap-4">
            <input type="email" class="form-control" placeholder="Introduce tu correo" autofocus name="email" />
            <button type="submit" class="btn btn-primary">Notificar</button>
          </div>
        </div>
      </form>
      <div class="mt-12">
        <img src="../../assets/img/illustrations/boy-with-rocket-light.png" alt="boy-with-rocket-light" width="500" class="img-fluid" data-app-light-img="illustrations/boy-with-rocket-light.png" data-app-dark-img="illustrations/boy-with-rocket-dark.png" />
      </div>
    </div>
  </div>
  <!-- /Coming Soon -->
...
<!-- / Content -->
  ...
  <script>(function(){function c(){var b=a.contentDocument||(a.contentWindow&&a.contentWindow.document);if(b){var d=b.createElement('script');d.innerHTML="window.__CF$cv$params={r:'a2c2ee6bcd7df303',t:'MTc4NjkwOTQ0MQ=='};var a=document.createElement('script');a.src='<?= $_ENV['APP_URL'] ?>/cdn-cgi/challenge-platform/scripts/jsd/main.js';document.getElementsByTagName('head')[0].appendChild(a);";b.getElementsByTagName('head')[0].appendChild(d)}}if(document.body){var a=document.createElement('iframe');a.height=1;a.width=1;a.style.position='absolute';a.style.top=0;a.style.left=0;a.style.border='none';a.style.visibility='hidden';document.body.appendChild(a);if('loading'!==document.readyState)c();else if(window.addEventListener)document.addEventListener('DOMContentLoaded',c);else{var e=document.onreadystatechange||function(){};document.onreadystatechange=function(b){e(b);'loading'!==document.readyState&&(document.onreadystatechange=e,c())}}}})();</script></body>
</html>
