...
<!-- / Navbar -->
  ...
  <div class="faq-header d-flex flex-column justify-content-center align-items-center h-px-300 position-relative">
    <img src="../../assets/img/pages/header.png" class="scaleX-n1-rtl faq-banner-img z-n1 rounded" alt="background image" />
      ...
      <div class="d-flex justify-content-between flex-column nav-align-left mb-2 mb-md-0">
        <ul class="nav nav-pills flex-column">
          <li class="nav-item">
            <button class="nav-link active" data-bs-toggle="tab" data-bs-target="#payment">
              <i class="icon-base bx bx-credit-card faq-nav-icon me-1_5"></i>
              <span class="align-middle">Payment</span>
            </button>
          </li>
          <li class="nav-item">
            <button class="nav-link" data-bs-toggle="tab" data-bs-target="#delivery">
              <i class="icon-base bx bx-shopping-bag faq-nav-icon me-1_5"></i>
              <span class="align-middle">Delivery</span>
            </button>
          </li>
          <li class="nav-item">
            <button class="nav-link" data-bs-toggle="tab" data-bs-target="#cancellation">
              <i class="icon-base bx bx-rotate-left faq-nav-icon me-1_5"></i>
          ...
          <li class="nav-item">
            <button class="nav-link" data-bs-toggle="tab" data-bs-target="#product">
              <i class="icon-base bx bx-cog faq-nav-icon me-1_5"></i>
        ...
        <div class="d-none d-md-block">
          <div class="my-4 d-flex justify-content-center">
            <img src="../../assets/img/illustrations/sitting-girl-with-laptop.png" class="img-fluid" width="240" alt="FAQ Image" />
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="tab-content p-0">
          ...
          <div class="d-flex mb-4 gap-4 align-items-center">
            <div>
              <span class="badge bg-label-primary rounded w-px-50 py-2">
                <i class="icon-base bx bx-credit-card icon-26px mt-50"></i>
              </span>
            </div>
            <div>
              <h5 class="mb-0">
          ...
          <div id="accordionPayment" class="accordion">
            <div class="card accordion-item">
              <h2 class="accordion-header">
                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" aria-expanded="true" data-bs-target="#accordionPayment-1" aria-controls="accordionPayment-1">When is payment taken for my order?</button>
              </h2>
            ...
            <div class="card accordion-item active">
              <h2 class="accordion-header">
                <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#accordionPayment-2" aria-controls="accordionPayment-2">How do I pay for my order?</button>
              </h2>
            ...
            <div class="card accordion-item">
              ...
              <div id="accordionPayment-3" class="accordion-collapse collapse">
                <div class="accordion-body">
                  ...
                  <a href="javascript:void(0);"><span class="__cf_email__" data-cfemail="08677a6c6d7a486b67657869667165696164266b6765">[email&#160;protected]</span></a>
                </div>
              </div>
            </div>
        ...
        <div class="tab-pane fade" id="delivery" role="tabpanel">
          <div class="d-flex mb-4 gap-4">
            <div>
              <span class="badge bg-label-primary rounded w-px-50 py-2">
                <i class="icon-base bx bx-cart icon-26px mt-50"></i>
              </span>
            </div>
            <div>
              <h5 class="mb-0">
        ...
        <div class="tab-pane fade" id="cancellation" role="tabpanel">
          <div class="d-flex mb-4 gap-4">
            <div>
              <span class="badge bg-label-primary rounded w-px-50 py-2">
                <i class="icon-base bx bx-revision icon-26px mt-50"></i>
              </span>
            </div>
            <div>
        ...
        <div class="tab-pane fade" id="product" role="tabpanel">
          <div class="d-flex mb-4 gap-4">
            <div>
              <span class="badge bg-label-primary rounded w-px-50 py-2">
                <i class="icon-base bx bx-camera icon-26px mt-50"></i>
              </span>
            </div>
            <div>
              <h5 class="mb-0">
          ...
          <div id="accordionProduct" class="accordion">
            ...
            <div class="card accordion-item">
              ...
              <div id="accordionProduct-3" class="accordion-collapse collapse">
                <div class="accordion-body">For the peace of your mind, we offer extended warranty plans that add additional year(s) of protection to the standard manufacturer’s warranty provided by us. To purchase or find out more about the extended warranty program, visit Extended Warranty section <a href="javascript:void(0);">here</a>.</div>
              </div>
            </div>
          </div>
        </div>
  ...
  <div class="row justify-content-center gap-sm-0 gap-6">
    <div class="col-sm-6">
      <div class="py-6 rounded bg-faq-section text-center">
        <span class="badge bg-label-primary p-2">
          <i class="icon-base bx bx-phone icon-26px mx-50 my-50"></i>
        </span>
    ...
    <div class="col-sm-6">
      <div class="py-6 rounded bg-faq-section text-center">
        ...
        <h5 class="mt-4 mb-1"><a class="text-heading" href="/cdn-cgi/l/email-protection#7119141d013119141d015f121e1c"><span class="__cf_email__" data-cfemail="a1c9c4cdd1e1c9c4cdd18fc2cecc">[email&#160;protected]</span></a></h5>
...
<!-- / Layout wrapper -->
  ...
  <script>(function(){function c(){var b=a.contentDocument||(a.contentWindow&&a.contentWindow.document);if(b){var d=b.createElement('script');d.innerHTML="window.__CF$cv$params={r:'a2c2edd689f03be9',t:'MTc4NjkwOTQxOA=='};var a=document.createElement('script');a.src='/cdn-cgi/challenge-platform/scripts/jsd/main.js';document.getElementsByTagName('head')[0].appendChild(a);";b.getElementsByTagName('head')[0].appendChild(d)}}if(document.body){var a=document.createElement('iframe');a.height=1;a.width=1;a.style.position='absolute';a.style.top=0;a.style.left=0;a.style.border='none';a.style.visibility='hidden';document.body.appendChild(a);if('loading'!==document.readyState)c();else if(window.addEventListener)document.addEventListener('DOMContentLoaded',c);else{var e=document.onreadystatechange||function(){};document.onreadystatechange=function(b){e(b);'loading'!==document.readyState&&(document.onreadystatechange=e,c())}}}})();</script></body>
</html>
