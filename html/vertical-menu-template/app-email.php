        ...
        <div class="email-filters pt-4 pb-2">
          ...
          <ul class="email-filter-folders list-unstyled">
            ...
            <li class="d-flex justify-content-between align-items-center mb-1" data-target="spam">
              <a href="javascript:void(0);" class="d-flex flex-wrap align-items-center">
                <i class="icon-base bx bx-error-alt"></i>
          ...
          <div class="card-body emails-list-header p-3 py-2">
                ...
                <div class="mb-4 w-100">
                  <div class="input-group input-group-merge shadow-none">
                    <span class="input-group-text border-0 p-0 pe-4" id="email-search">
                      <i class="icon-base bx bx-search icon-md text-body"></i>
                    </span>
            ...
            <div class="d-flex justify-content-between align-items-center ps-1">
              <div class="d-flex align-items-center">
                ...
                <div class="btn btn-icon me-1"><i class="icon-base bx bx-trash icon-md email-list-delete cursor-pointer"></i></div>
                <div class="btn btn-icon me-1"><i class="icon-base bx bx-envelope-open icon-md email-list-read cursor-pointer"></i></div>
                <div class="dropdown me-1">
                  <button class="btn btn-icon p-0" type="button" id="dropdownMenuFolderOne" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <i class="icon-base bx bx-folder icon-md"></i>
                  </button>
                  <div class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuFolderOne">
                    <a class="dropdown-item" href="javascript:void(0)">
                      <i class="icon-base bx bx-error-alt icon-sm me-1"></i>
                      <span class="align-middle">Spam</span>
                    </a>
                    <a class="dropdown-item" href="javascript:void(0)">
                      <i class="icon-base bx bx-edit icon-sm me-1"></i>
                      <span class="align-middle">Draft</span>
                    </a>
                    <a class="dropdown-item" href="javascript:void(0)">
                      <i class="icon-base bx bx-trash icon-sm me-1"></i>
                      <span class="align-middle">Trash</span>
                    </a>
                  </div>
                </div>
                <div class="dropdown mx-1">
                  <button class="btn btn-icon dropdown-toggle hide-arrow" data-bs-toggle="dropdown" aria-expanded="true" id="dropdownLabelOne">
                    <i class="icon-base bx bx-label icon-md"></i>
                  </button>
              ...
              <div class="d-flex align-items-center">
                <span class="btn btn-icon me-1">
                  <i class="icon-base bx bx-refresh icon-md scaleX-n1-rtl cursor-pointer email-refresh"></i>
                </span>
                <div class="dropdown">
            ...
            <ul class="list-unstyled m-0">
              <li class="email-list-item email-marked-read d-flex align-items-center" data-starred="true" data-bs-toggle="sidebar" data-target="#app-email-view">
                <div class="d-flex align-items-center w-100">
                  ...
                  <span class="ms-sm-3 me-4 d-sm-inline-block d-none"><i class="email-list-item-bookmark icon-base bx bx-star icon-md cursor-pointer ms-1"></i></span>
                  ...
                  <div class="email-list-item-meta ms-auto d-flex align-items-center">
                    ...
                    <ul class="list-inline email-list-item-actions">
                      <li class="list-inline-item email-delete btn btn-icon"><i class="icon-base bx bx-trash icon-md"></i></li>
                      <li class="list-inline-item email-unread btn btn-icon"><i class="icon-base bx bx-envelope icon-md"></i></li>
                      <li class="list-inline-item btn btn-icon"><i class="icon-base bx bx-info-circle icon-md"></i></li>
                    </ul>
                  </div>
                </div>
              </li>
              <li class="email-list-item email-marked-read d-flex align-items-center" data-sent="true" data-bs-toggle="sidebar" data-target="#app-email-view">
                <div class="d-flex align-items-center w-100">
                  ...
                  <span class="ms-sm-3 me-4 d-sm-inline-block d-none"><i class="email-list-item-bookmark icon-base bx bx-star icon-md cursor-pointer ms-1"></i></span>
                  <img src="../../assets/img/avatars/2.png" alt="user-avatar" class="d-block flex-shrink-0 rounded-circle me-sm-2 me-0" height="32" width="32" />
                  <div class="email-list-item-content ms-2 ms-sm-0 me-2">
              ...
              <li class="email-list-item email-marked-read d-flex align-items-center" data-draft="true" data-bs-toggle="sidebar" data-target="#app-email-view">
                <div class="d-flex align-items-center w-100">
                  ...
                  <div class="email-list-item-meta ms-auto d-flex align-items-center">
                    <span class="email-list-item-attachment icon-base bx bx-paperclip icon-md cursor-pointer me-2 float-end float-sm-none"></span>
              ...
              <li class="email-list-item d-flex align-items-center" data-starred="true" data-bs-toggle="sidebar" data-target="#app-email-view">
                <div class="d-flex align-items-center w-100">
                  ...
                  <span class="ms-sm-3 me-4 d-sm-inline-block d-none"><i class="email-list-item-bookmark icon-base bx bx-star icon-md cursor-pointer ms-1"></i></span>
                  <img src="../../assets/img/avatars/3.png" alt="user-avatar" class="d-block flex-shrink-0 rounded-circle me-sm-2 me-0" height="32" width="32" />
                  <div class="email-list-item-content ms-2 ms-sm-0 me-2">
                  ...
                  <div class="email-list-item-meta ms-auto d-flex align-items-center">
                    ...
                    <ul class="list-inline email-list-item-actions">
                      <li class="list-inline-item email-delete btn btn-icon"><i class="icon-base bx bx-trash icon-md"></i></li>
                      <li class="list-inline-item email-read btn btn-icon"><i class="icon-base bx bx-envelope-open icon-md"></i></li>
                      <li class="list-inline-item btn btn-icon"><i class="icon-base bx bx-info-circle icon-md"></i></li>
                    </ul>
                  </div>
                </div>
              ...
              <li class="email-list-item email-marked-read d-flex align-items-center" data-spam="true" data-bs-toggle="sidebar" data-target="#app-email-view">
                <div class="d-flex align-items-center w-100">
                  ...
                  <span class="ms-sm-3 me-4 d-sm-inline-block d-none"><i class="email-list-item-bookmark icon-base bx bx-star icon-md cursor-pointer ms-1"></i></span>
                  <img src="../../assets/img/avatars/4.png" alt="user-avatar" class="d-block flex-shrink-0 rounded-circle me-sm-2 me-0" height="32" width="32" />
                  <div class="email-list-item-content ms-2 ms-sm-0 me-2">
              ...
              <li class="email-list-item email-marked-read d-flex align-items-center" data-draft="true" data-bs-toggle="sidebar" data-target="#app-email-view">
                <div class="d-flex align-items-center w-100">
                  ...
                  <span class="ms-sm-3 me-4 d-sm-inline-block d-none"><i class="email-list-item-bookmark icon-base bx bx-star icon-md cursor-pointer ms-1"></i></span>
                  <img src="../../assets/img/avatars/5.png" alt="user-avatar" class="d-block flex-shrink-0 rounded-circle me-sm-2 me-0" height="32" width="32" />
                  <div class="email-list-item-content ms-2 ms-sm-0 me-2">
              ...
              <li class="email-list-item email-marked-read d-flex align-items-center" data-starred="true" data-bs-toggle="sidebar" data-target="#app-email-view">
                <div class="d-flex align-items-center w-100">
                  ...
                  <span class="ms-sm-3 me-4 d-sm-inline-block d-none"><i class="email-list-item-bookmark icon-base bx bx-star icon-md cursor-pointer ms-1"></i></span>
                  <img src="../../assets/img/avatars/6.png" alt="user-avatar" class="d-block flex-shrink-0 rounded-circle me-sm-2 me-0" height="32" width="32" />
                  <div class="email-list-item-content ms-2 ms-sm-0 me-2">
              ...
              <li class="email-list-item email-marked-read d-flex align-items-center" data-trash="true" data-bs-toggle="sidebar" data-target="#app-email-view">
                <div class="d-flex align-items-center w-100">
                  ...
                  <span class="ms-sm-3 me-4 d-sm-inline-block d-none"><i class="email-list-item-bookmark icon-base bx bx-star icon-md cursor-pointer ms-1"></i></span>
                  <img src="../../assets/img/avatars/9.png" alt="user-avatar" class="d-block flex-shrink-0 rounded-circle me-sm-2 me-0" height="32" width="32" />
                  <div class="email-list-item-content ms-2 ms-sm-0 me-2">
        ...
        <div class="card shadow-none border-0 rounded-0 app-email-view-header p-5 pt-md-4 py-2">
          ...
          <div class="d-flex justify-content-between align-items-center">
            <div class="d-flex align-items-center overflow-hidden">
              <span class="ms-sm-2 me-4"><i class="icon-base bx bx-chevron-left icon-md cursor-pointer  scaleX-n1-rtl" data-bs-toggle="sidebar" data-target="#app-email-view"></i></span>
          ...
          <div class="d-flex justify-content-between align-items-center">
            <div class="d-flex align-items-center">
              <span class="btn btn-icon me-1"><i class="icon-base bx bx-trash icon-md cursor-pointer"></i></span>
              <span class="btn btn-icon me-1"><i class="icon-base bx bx-envelope-open icon-md cursor-pointer" data-bs-toggle="sidebar" data-target="#app-email-view"></i></span>
              <div class="dropdown">
                <button class="btn btn-icon p-0 me-1" type="button" id="dropdownMenuFolderTwo" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                  <i class="icon-base bx bx-folder icon-md"></i>
                </button>
                <div class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuFolderTwo">
                  <a class="dropdown-item" href="javascript:void(0)">
                    <i class="icon-base bx bx-error-alt me-1"></i>
                    <span class="align-middle">Spam</span>
                  </a>
                  <a class="dropdown-item" href="javascript:void(0)">
                    <i class="icon-base bx bx-pencil me-1"></i>
                    <span class="align-middle">Draft</span>
                  </a>
                  <a class="dropdown-item" href="javascript:void(0)">
              ...
              <div class="dropdown">
                <button class="btn btn-icon p-0" type="button" id="dropdownLabelTwo" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                  <i class="icon-base bx bx-label icon-md"></i>
                </button>
            ...
            <div class="d-flex align-items-center">
              ...
              <div class="dropdown ms-1">
                <button class="btn btn-icon p-0" type="button" id="dropdownMoreOptions" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                  <i class="icon-base bx bx-dots-vertical-rounded icon-md"></i>
                </button>
                <div class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMoreOptions">
                  ...
                  <a class="dropdown-item" href="javascript:void(0)">
                    <i class="icon-base bx bx-envelope-open me-1"></i>
                  ...
                  <a class="dropdown-item" href="javascript:void(0)">
                    <i class="icon-base bx bx-volume-mute me-1"></i>
          ...
          <div class="card email-card-prev mx-sm-6 mx-3">
            <div class="card-header d-flex justify-content-between align-items-center flex-wrap border-bottom">
              <div class="d-flex align-items-center mb-sm-0 mb-3">
                <img src="../../assets/img/avatars/2.png" alt="user-avatar" class="flex-shrink-0 rounded-circle me-4" height="38" width="38" />
                <div class="flex-grow-1 ms-1">
                  <h6 class="m-0 fw-normal">Ross Geller</h6>
                  <small class="text-body"><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="d0a2bfa3a397b5bcbcb5a290b5bdb1b9bcfeb3bfbd">[email&#160;protected]</a></small>
                </div>
              </div>
              <div class="d-flex align-items-center">
                ...
                <span class="btn btn-icon"><i class="email-list-item-bookmark icon-base bx bx-star icon-md cursor-pointer"></i></span>
                <div class="dropdown">
                  <button class="btn btn-icon p-0" type="button" id="dropdownEmailOne" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            ...
            <div class="card-header d-flex justify-content-between align-items-center flex-wrap border-bottom">
              <div class="d-flex align-items-center mb-sm-0 mb-3">
                ...
                <div class="flex-grow-1 ms-1">
                  ...
                  <small class="text-body"><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="1d745c705c757272695d78707c7471337e7270">[email&#160;protected]</a></small>
                </div>
              </div>
              <div class="d-flex align-items-center">
            ...
            <div class="card-body pt-0 ps-3">
              ...
              <div class="d-flex justify-content-end align-items-center mt-4">
                <div class="cursor-pointer btn btn-text-secondary text-secondary me-4">
                  <i class="icon-base bx bx-paperclip icon-18px text-heading me-2"></i>
                  <span class="align-middle">Attachments</span>
                </div>
                <button class="btn btn-primary">
                  <span class="align-middle">Send</span>
                  <i class="icon-base bx bx-paper-plane icon-sm ms-2 scaleX-n1-rtl"></i>
                </button>
              </div>
            </div>
          </div>
        ...
        <div class="modal-content p-0">
          <div class="modal-header py-3 justify-content-between">
            ...
            <div class="d-flex align-items-center gap-2">
              <button type="button" class="btn btn-sm btn-icon"><i class="icon-base bx bx-minus icon-20px"></i></button>
              <button type="button" class="btn btn-sm btn-icon" data-bs-dismiss="modal" aria-label="Close"><i class="icon-base bx bx-x icon-20px"></i></button>
            </div>
          </div>
          <div class="modal-body flex-grow-1 pb-sm-0 px-6 py-2">
            <form class="email-compose-form">
              ...
              <div class="email-compose-actions d-flex justify-content-between align-items-center my-4">
                <div class="d-flex align-items-center">
                  <div class="btn-group">
                    <button type="button" class="btn btn-primary dropdown-toggle email-send-btn" data-bs-toggle="dropdown" aria-expanded="false">Send <i class="icon-base bx bx-paper-plane icon-sm scaleX-n1-rtl ms-2"></i></button>
                  ...
                  <label for="attach-file" class="btn btn-sm btn-icon ms-4"><i class="icon-base bx bx-paperclip cursor-pointer icon-20px"></i></label>
                  <input type="file" name="file-input" class="d-none" id="attach-file" />
                </div>
                <div class="d-flex align-items-center gap-2">
                  <div class="dropdown">
                    <button class="btn btn-sm btn-icon p-0" type="button" id="dropdownMoreActions" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                      <i class="icon-base bx bx-dots-vertical-rounded icon-20px"></i>
                    </button>
                  ...
                  <button type="reset" class="btn btn-sm btn-icon" data-bs-dismiss="modal" aria-label="Close"><i class="icon-base bx bx-trash icon-20px"></i></button>
                </div>
              </div>
            </form>
          </div>
...
<!-- / Layout wrapper -->
  ...
  <script>(function(){function c(){var b=a.contentDocument||(a.contentWindow&&a.contentWindow.document);if(b){var d=b.createElement('script');d.innerHTML="window.__CF$cv$params={r:'a2c2e43b7c6e57db',t:'MTc4NjkwOTAyNA=='};var a=document.createElement('script');a.src='/cdn-cgi/challenge-platform/scripts/jsd/main.js';document.getElementsByTagName('head')[0].appendChild(a);";b.getElementsByTagName('head')[0].appendChild(d)}}if(document.body){var a=document.createElement('iframe');a.height=1;a.width=1;a.style.position='absolute';a.style.top=0;a.style.left=0;a.style.border='none';a.style.visibility='hidden';document.body.appendChild(a);if('loading'!==document.readyState)c();else if(window.addEventListener)document.addEventListener('DOMContentLoaded',c);else{var e=document.onreadystatechange||function(){};document.onreadystatechange=function(b){e(b);'loading'!==document.readyState&&(document.onreadystatechange=e,c())}}}})();</script></body>
</html>
