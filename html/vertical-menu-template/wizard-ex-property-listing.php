...
<html
  ...
  <head>
    ...
    <meta name="robots" content="noindex, nofollow" />
      ...
      <title>Demo: Property Listing - Wizard Examples | Sneat - Bootstrap Dashboard PRO</title>
  ...
  <div id="wizard-property-listing" class="bs-stepper vertical mt-2">
    <div class="bs-stepper-header border-end">
      ...
      <div class="step" data-target="#property-area">
        <button type="button" class="step-trigger">
          <span class="bs-stepper-circle">
            <i class="icon-base bx bx-map icon-md"></i>
          </span>
          <span class="bs-stepper-label">
      ...
      <div class="step" data-target="#price-details">
        <button type="button" class="step-trigger">
          <span class="bs-stepper-circle">
            <i class="icon-base bx bx-dollar icon-md"></i>
          </span>
          <span class="bs-stepper-label">
      ...
      <form id="wizard-property-listing-form" onSubmit="return false">
          ...
          <div class="row g-6">
            ...
            <div class="col-sm-6 form-password-toggle form-control-validation">
              ...
              <div class="input-group input-group-merge">
                ...
                <span id="passwordToggler" class="input-group-text cursor-pointer"><i class="icon-base bx bx-hide"></i></span>
              </div>
            </div>
            <div class="col-sm-6 form-control-validation">
            ...
            <div class="col-12 d-flex justify-content-between">
              ...
              <button class="btn btn-primary btn-next"><span class="align-middle d-sm-inline-block d-none me-sm-2">Next</span> <i class="icon-base bx bx-right-arrow-alt icon-sm scaleX-n1-rtl"></i></button>
            </div>
          </div>
        </div>
        ...
        <div id="property-details" class="content">
          <div class="row g-6">
                  ...
                  <div class="form-check custom-option custom-option-icon">
                    <label class="form-check-label custom-option-content" for="customRadioSell">
                      <span class="custom-option-body">
                        ...
                        <small
                          >Post your property for sale.<br />
                          Unlimited free listing.</small
                        >
                      </span>
                  ...
                  <div class="form-check custom-option custom-option-icon">
                    <label class="form-check-label custom-option-content" for="customRadioRent">
                      <span class="custom-option-body">
                        ...
                        <small
                          >Post your property for rent.<br />
                          Unlimited free listing.</small
                        >
                      </span>
            ...
            <div class="col-12 d-flex justify-content-between">
              <button class="btn btn-label-secondary btn-prev"><i class="icon-base bx bx-left-arrow-alt scaleX-n1-rtl icon-sm me-sm-2 me-0"></i> <span class="align-middle d-sm-inline-block d-none">Previous</span></button>
              <button class="btn btn-primary btn-next"><span class="align-middle d-sm-inline-block d-none me-sm-2">Next</span> <i class="icon-base bx bx-right-arrow-alt scaleX-n1-rtl icon-sm"></i></button>
            </div>
          </div>
        </div>
        ...
        <div id="property-features" class="content">
          <div class="row g-6">
            ...
            <div class="col-sm-6 form-control-validation">
              <p class="mb-2">Is there any common area?</p>
            ...
            <div class="col-sm-6 form-control-validation">
              <p class="mb-2">Is there any attached balcony?</p>
              <div class="form-check my-2 ms-2">
        ...
        <div id="property-area" class="content">
          <div class="row g-6">
            ...
            <div class="col-sm-6 form-control-validation">
              <p class="mb-2">Possession Status</p>
              <div class="form-check my-2 ms-2">
            ...
            <div class="col-sm-6 form-control-validation">
              <p class="mb-2">Is Property Facing Main Road?</p>
              <div class="form-check my-2 ms-2">
...
<!-- / Layout wrapper -->
  ...
  <script>(function(){function c(){var b=a.contentDocument||(a.contentWindow&&a.contentWindow.document);if(b){var d=b.createElement('script');d.innerHTML="window.__CF$cv$params={r:'a2c2fb52996ca6ac',t:'MTc4NjkwOTk3MA=='};var a=document.createElement('script');a.src='/cdn-cgi/challenge-platform/scripts/jsd/main.js';document.getElementsByTagName('head')[0].appendChild(a);";b.getElementsByTagName('head')[0].appendChild(d)}}if(document.body){var a=document.createElement('iframe');a.height=1;a.width=1;a.style.position='absolute';a.style.top=0;a.style.left=0;a.style.border='none';a.style.visibility='hidden';document.body.appendChild(a);if('loading'!==document.readyState)c();else if(window.addEventListener)document.addEventListener('DOMContentLoaded',c);else{var e=document.onreadystatechange||function(){};document.onreadystatechange=function(b){e(b);'loading'!==document.readyState&&(document.onreadystatechange=e,c())}}}})();</script></body>
</html>
