...
<html
  ...
  <head>
    ...
    <meta name="robots" content="noindex, nofollow" />
      ...
      <title>Demo: Buttons - UI elements | Sneat - Bootstrap Dashboard PRO</title>
            ...
            <div class="col-lg-4">
              ...
              <div class="demo-inline-spacing">
                ...
                <button type="button" class="btn btn-secondary">
                  <span class="icon-base bx bx-bell icon-sm me-2"></span>Secondary
                </button>
              </div>
              <div class="demo-inline-spacing">
            ...
            <div class="col-lg-4">
              ...
              <div class="demo-inline-spacing">
                <button type="button" class="btn btn-facebook">
                  <i class="icon-base bx bxl-facebook icon-sm me-2"></i>Facebook
                </button>
                <button type="button" class="btn btn-twitter">
                  <i class="icon-base bx bxl-twitter icon-sm me-2"></i>Twitter
                </button>
              </div>
              <div class="demo-inline-spacing">
                <button type="button" class="btn rounded-pill btn-google-plus">
                  <i class="icon-base bx bxl-google-plus icon-sm me-2"></i>Google+
                </button>
                <button type="button" class="btn rounded-pill btn-instagram">
                  <i class="icon-base bx bxl-instagram icon-sm me-2"></i>Instagram
                </button>
              </div>
            </div>
            <div class="col-lg-4">
              ...
              <div class="demo-inline-spacing">
                <button type="button" class="btn btn-label-linkedin">
                  <i class="icon-base bx bxl-linkedin icon-sm me-2"></i>Linkedin
                </button>
                <button type="button" class="btn btn-label-github">
                  <i class="icon-base bx bxl-github icon-sm me-2"></i>Github
                </button>
              </div>
              <div class="demo-inline-spacing">
                <button type="button" class="btn rounded-pill btn-label-pinterest">
                  <i class="icon-base bx bxl-pinterest icon-sm me-2"></i>Pinterest
                </button>
                <button type="button" class="btn rounded-pill btn-label-slack">
                  <i class="icon-base bx bxl-slack icon-sm me-2"></i>Slack
                </button>
              </div>
            </div>
            <div class="col-lg-4">
              ...
              <div class="demo-inline-spacing">
                <button type="button" class="btn btn-outline-dribbble">
                  <i class="icon-base bx bxl-dribbble icon-sm me-2"></i>Dribbble
                </button>
                <button type="button" class="btn btn-text-reddit">
                  <i class="icon-base bx bxl-reddit icon-sm me-2"></i>Reddit
                </button>
              </div>
              <div class="demo-inline-spacing">
                <button type="button" class="btn rounded-pill btn-outline-youtube">
                  <i class="icon-base bx bxl-youtube icon-sm me-2"></i>Youtube
                </button>
                <button type="button" class="btn rounded-pill btn-text-vimeo">
                  <i class="icon-base bx bxl-vimeo icon-sm me-2"></i>Vimeo
                </button>
              </div>
            </div>
          </div>
        ...
        <div class="card-body">
          <div class="row gy-3">
            ...
            <div class="col-lg-4">
              ...
              <div class="demo-inline-spacing">
                <button type="button" class="btn btn-icon btn-label-linkedin">
                  <i class="icon-base bx bxl-linkedin icon-md"></i>
                </button>
                <button type="button" class="btn btn-icon btn-label-github">
                  <i class="icon-base bx bxl-github icon-md"></i>
                </button>
                <button type="button" class="btn btn-icon rounded-pill btn-label-pinterest">
                  <i class="icon-base bx bxl-pinterest icon-md"></i>
                </button>
                <button type="button" class="btn btn-icon rounded-pill btn-label-slack">
                  <i class="icon-base bx bxl-slack icon-md"></i>
                </button>
              </div>
            </div>
            <div class="col-lg-4">
              <small class="fw-medium">Outline Icons</small>
              <div class="demo-inline-spacing">
                <button type="button" class="btn btn-icon btn-outline-dribbble">
                  <i class="icon-base bx bxl-dribbble icon-md"></i>
                </button>
                <button type="button" class="btn btn-icon btn-text-reddit">
                  <i class="icon-base bx bxl-reddit icon-md"></i>
                </button>
                <button type="button" class="btn btn-icon rounded-pill btn-outline-youtube">
                  <i class="icon-base bx bxl-youtube icon-md"></i>
                </button>
                <button type="button" class="btn btn-icon rounded-pill btn-text-vimeo">
                  <i class="icon-base bx bxl-vimeo icon-md"></i>
                </button>
              </div>
            </div>
          </div>
            ...
            <div class="col-xl-6">
              ...
              <div class="demo-vertical-spacing">
                ...
                <div class="btn-group" role="group" aria-label="Basic checkbox toggle button group">
                  ...
                  <label class="btn btn-outline-primary d-flex flex-column" for="btncheck1"
                    ><span class="d-none d-sm-block">Checkbox</span>1 ( pre-checked )</label
                  >

                  <input type="checkbox" class="btn-check" id="btncheck2" />
                  <label class="btn btn-outline-primary d-flex flex-column" for="btncheck2"
                    ><span class="d-none d-sm-block">Checkbox</span>2</label
                  >

                  <input type="checkbox" class="btn-check" id="btncheck3" />
                  <label class="btn btn-outline-primary d-flex flex-column" for="btncheck3"
                    ><span class="d-none d-sm-block">Checkbox</span>3</label
                  >
                </div>
                <br />
                <!-- Radio -->
