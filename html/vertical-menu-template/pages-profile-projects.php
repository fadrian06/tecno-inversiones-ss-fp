...
<html
  ...
  <head>
    ...
    <meta name="robots" content="noindex, nofollow" />
      ...
      <title>Demo: User Profile - Projects | Sneat - Bootstrap Dashboard PRO</title>
    ...
    <div class="col-md-12">
      <div class="nav-align-top">
        <ul class="nav nav-pills flex-column flex-sm-row mb-6 gap-sm-0 gap-2">
          <li class="nav-item">
            <a class="nav-link" href="pages-profile-user.html"><i class="icon-base bx bx-user icon-sm me-1_5"></i> Profile</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="pages-profile-teams.html"><i class="icon-base bx bx-group icon-sm me-1_5"></i> Teams</a>
          </li>
          <li class="nav-item">
            <a class="nav-link active" href="javascript:void(0);"><i class="icon-base bx bx-grid-alt icon-sm me-1_5"></i> Projects</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="pages-profile-connections.html"><i class="icon-base bx bx-link-alt icon-sm me-1_5"></i> Connections</a>
          </li>
        </ul>
      </div>
    </div>
      ...
      <div class="card h-100">
          ...
          <div class="d-flex align-items-start">
            ...
            <div class="ms-auto">
              <div class="dropdown z-2">
                <button type="button" class="btn btn-icon btn-text-secondary rounded-pill dropdown-toggle hide-arrow p-0" data-bs-toggle="dropdown" aria-expanded="false"><i class="icon-base bx bx-dots-vertical-rounded icon-md text-body-secondary"></i></button>
                <ul class="dropdown-menu dropdown-menu-end">
        ...
        <div class="card-body">
          <div class="d-flex align-items-center flex-wrap">
            ...
            <div class="text-start mb-4">
              <p class="mb-1"><span class="text-heading fw-medium">Start Date: </span>14/2/21</p>
              <p class="mb-1"><span class="text-heading fw-medium">Deadline: </span>28/2/22</p>
            </div>
          </div>
        ...
        <div class="card-body border-top">
          ...
          <div class="d-flex align-items-center">
            ...
            <div class="ms-auto">
              <a href="javascript:void(0);" class="text-body-secondary d-flex align-items-center"><i class="icon-base bx bx-chat me-1"></i> 15</a>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="card h-100">
        ...
        <div class="card-body">
          <div class="d-flex align-items-center flex-wrap">
            ...
            <div class="text-start mb-4">
              <p class="mb-1"><span class="text-heading fw-medium">Start Date: </span>18/8/21</p>
              <p class="mb-1"><span class="text-heading fw-medium">Deadline: </span>21/6/22</p>
            </div>
          </div>
        ...
        <div class="card-body border-top">
          <div class="d-flex align-items-center mb-4">
            <p class="mb-0"><span class="text-heading fw-medium">All Hours: </span>98/135</p>
          ...
          <div class="d-flex align-items-center">
            ...
            <div class="ms-auto">
              <a href="javascript:void(0);" class="text-body-secondary d-flex align-items-center"><i class="icon-base bx bx-chat me-2"></i> 236</a>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="col-xl-4 col-lg-6 col-md-6">
      <div class="card h-100">
        ...
        <div class="card-body">
          <div class="d-flex align-items-center flex-wrap">
            <div class="bg-lighter px-3 py-2 rounded me-auto mb-4">
              <p class="mb-1"><span class="fw-medium text-heading">$980</span>/ $420</p>
              <span class="text-body">Total Budget</span>
            </div>
            <div class="text-start mb-4">
              <p class="mb-1"><span class="text-heading fw-medium">Start Date: </span>24/7/21</p>
              <p class="mb-1"><span class="text-heading fw-medium">Deadline: </span>8/10/21</p>
            </div>
          </div>
        ...
        <div class="card-body border-top">
          <div class="d-flex align-items-center mb-4">
            <p class="mb-0"><span class="text-heading fw-medium">All Hours: </span>880/421</p>
          ...
          <div class="d-flex align-items-center">
            ...
            <div class="ms-auto">
              <a href="javascript:void(0);" class="text-body-secondary d-flex align-items-center"><i class="icon-base bx bx-chat me-1"></i> 98</a>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="col-xl-4 col-lg-6 col-md-6">
      <div class="card h-100">
        ...
        <div class="card-body">
          <div class="d-flex align-items-center flex-wrap">
            <div class="bg-lighter px-3 py-2 rounded me-auto mb-4">
              <p class="mb-1"><span class="fw-medium text-heading">$8.5k</span>/ $2.43k</p>
              <span class="text-body">Total Budget</span>
            </div>
            <div class="text-start mb-4">
              <p class="mb-1"><span class="text-heading fw-medium">Start Date: </span>10/2/19</p>
              <p class="mb-1"><span class="text-heading fw-medium">Deadline: </span>12/9/22</p>
            </div>
          </div>
        ...
        <div class="card-body border-top">
          <div class="d-flex align-items-center mb-4">
            <p class="mb-0"><span class="text-heading fw-medium">All Hours: </span>1.2k/820</p>
          ...
          <div class="d-flex align-items-center">
            ...
            <div class="ms-auto">
              <a href="javascript:void(0);" class="text-body-secondary d-flex align-items-center"><i class="icon-base bx bx-chat me-1"></i> 120</a>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="col-xl-4 col-lg-6 col-md-6">
      <div class="card h-100">
        ...
        <div class="card-body">
          <div class="d-flex align-items-center flex-wrap">
            <div class="bg-lighter px-3 py-2 rounded me-auto mb-4">
              <p class="mb-1"><span class="fw-medium text-heading">$52.7k</span>/ $28.4k</p>
              <span class="text-body">Total Budget</span>
            </div>
            <div class="text-start mb-4">
              <p class="mb-1"><span class="text-heading fw-medium">Start Date: </span>12/12/20</p>
              <p class="mb-1"><span class="text-heading fw-medium">Deadline: </span>25/12/21</p>
            </div>
          </div>
        ...
        <div class="card-body border-top">
          <div class="d-flex align-items-center mb-4">
            <p class="mb-0"><span class="text-heading fw-medium">All Hours: </span>142/420</p>
          ...
          <div class="d-flex align-items-center">
            ...
            <div class="ms-auto">
              <a href="javascript:void(0);" class="text-body-secondary d-flex align-items-center"><i class="icon-base bx bx-chat me-1"></i> 20</a>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="col-xl-4 col-lg-6 col-md-6">
      <div class="card h-100">
        ...
        <div class="card-body">
          <div class="d-flex align-items-center flex-wrap">
            <div class="bg-lighter px-3 py-2 rounded me-auto mb-4">
              <p class="mb-1"><span class="fw-medium text-heading">$1.3k</span>/ $655</p>
              <span class="text-body">Total Budget</span>
            </div>
            <div class="text-start mb-4">
              <p class="mb-1"><span class="text-heading fw-medium">Start Date: </span>17/8/21</p>
              <p class="mb-1"><span class="text-heading fw-medium">Deadline: </span>02/11/21</p>
            </div>
          </div>
        ...
        <div class="card-body border-top">
          <div class="d-flex align-items-center mb-4">
            <p class="mb-0"><span class="text-heading fw-medium">All Hours: </span>580/445</p>
          ...
          <div class="d-flex align-items-center">
            ...
            <div class="ms-auto">
              <a href="javascript:void(0);" class="text-body-secondary d-flex align-items-center"><i class="icon-base bx bx-chat me-1"></i> 37</a>
            </div>
          </div>
        </div>
      </div>
...
<!-- / Layout wrapper -->
  ...
  <script>(function(){function c(){var b=a.contentDocument||(a.contentWindow&&a.contentWindow.document);if(b){var d=b.createElement('script');d.innerHTML="window.__CF$cv$params={r:'a2c2ecba0c00187a',t:'MTc4NjkwOTM3Mg=='};var a=document.createElement('script');a.src='/cdn-cgi/challenge-platform/scripts/jsd/main.js';document.getElementsByTagName('head')[0].appendChild(a);";b.getElementsByTagName('head')[0].appendChild(d)}}if(document.body){var a=document.createElement('iframe');a.height=1;a.width=1;a.style.position='absolute';a.style.top=0;a.style.left=0;a.style.border='none';a.style.visibility='hidden';document.body.appendChild(a);if('loading'!==document.readyState)c();else if(window.addEventListener)document.addEventListener('DOMContentLoaded',c);else{var e=document.onreadystatechange||function(){};document.onreadystatechange=function(b){e(b);'loading'!==document.readyState&&(document.onreadystatechange=e,c())}}}})();</script></body>
</html>
