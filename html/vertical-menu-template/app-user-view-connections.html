          ...
          <div class="info-container">
            <ul class="list-unstyled mb-6">
              ...
              <li class="mb-2">
                ...
                <span><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="b9cfd8dfded6cdf9cfccd5cdccd2d0cb97d6cbde">[email&#160;protected]</a></span>
              </li>
              <li class="mb-2">
    ...
    <div class="col-xl-8 col-lg-7 order-0 order-md-1">
      ...
      <div class="nav-align-top">
        <ul class="nav nav-pills flex-column flex-md-row mb-6 flex-wrap row-gap-2">
          <li class="nav-item">
            <a class="nav-link" href="app-user-view-account.html"><i class="icon-base bx bx-user icon-sm me-1_5"></i>Account</a>
          </li>
          <li class="nav-item">
          ...
          <li class="nav-item">
            <a class="nav-link active" href="javascript:void(0);"><i class="icon-base bx bx-link icon-sm me-1_5"></i>Connections</a>
          </li>
        </ul>
      </div>
      <!--/ User Pills -->
        ...
        <div class="card-body pt-0">
          <div class="d-flex mb-4 align-items-center">
            <div class="flex-shrink-0">
              <img src="../../assets/img/icons/brands/google.png" alt="google" class="me-4" height="36" />
            </div>
          ...
          <div class="d-flex mb-4 align-items-center">
            <div class="flex-shrink-0">
              <img src="../../assets/img/icons/brands/slack.png" alt="slack" class="me-4" height="36" />
            </div>
            <div class="flex-grow-1 d-flex align-items-center justify-content-between">
              <div class="mb-sm-0 mb-2">
          ...
          <div class="d-flex mb-4 align-items-center">
            <div class="flex-shrink-0">
              <img src="../../assets/img/icons/brands/github.png" alt="github" class="me-4" height="36" />
            </div>
            <div class="flex-grow-1 d-flex align-items-center justify-content-between">
              <div class="mb-sm-0 mb-2">
          ...
          <div class="d-flex mb-4 align-items-center">
            <div class="flex-shrink-0">
              <img src="../../assets/img/icons/brands/mailchimp.png" alt="mailchimp" class="me-4" height="36" />
            </div>
            <div class="flex-grow-1 d-flex align-items-center justify-content-between">
              <div class="mb-sm-0 mb-2">
          ...
          <div class="d-flex align-items-center">
            <div class="flex-shrink-0">
              <img src="../../assets/img/icons/brands/asana.png" alt="asana" class="me-4" height="36" />
            </div>
            <div class="flex-grow-1 d-flex align-items-center justify-content-between">
              <div class="mb-sm-0 mb-2">
      ...
      <div class="card mb-6">
        ...
        <div class="card-body pt-0">
          <div class="d-flex mb-4 align-items-center">
            <div class="flex-shrink-0">
              <img src="../../assets/img/icons/brands/facebook.png" alt="facebook" class="me-4" height="36" />
            </div>
            <div class="flex-grow-1 row align-items-center me-n1">
              ...
              <div class="col-5 text-end">
                <button class="btn btn-label-secondary btn-icon"><i class="icon-base bx bx-link icon-md"></i></button>
              </div>
            </div>
          </div>
          <div class="d-flex mb-4 align-items-center">
            <div class="flex-shrink-0">
              <img src="../../assets/img/icons/brands/twitter-light.png" alt="twitter" class="me-4" height="36" data-app-dark-img="icons/brands/twitter-dark.png" data-app-light-img="icons/brands/twitter-light.png"/>
            </div>
            <div class="flex-grow-1 row align-items-center me-n1">
              <div class="col-7 mb-sm-0 mb-2">
                <h6 class="mb-1">Twitter</h6>
                <a href="https://x.com/Theme_Selection" class="small" target="_blank">@ThemeSelection</a>
              </div>
              <div class="col-5 text-end">
                <button class="btn btn-label-danger btn-icon"><i class="icon-base bx bx-trash icon-md"></i></button>
              </div>
            </div>
          </div>
          <div class="d-flex mb-4 align-items-center">
            <div class="flex-shrink-0">
              <img src="../../assets/img/icons/brands/linkedin.png" alt="linkedin" class="me-4" height="36" />
            </div>
            <div class="flex-grow-1 row align-items-center me-n1">
              <div class="col-7 mb-sm-0 mb-2">
                <h6 class="mb-1">linkedin</h6>
                <a href="https://www.instagram.com/themeselection/" class="small" target="_blank">@ThemeSelection</a>
              </div>
              <div class="col-5 text-end">
                <button class="btn btn-label-danger btn-icon"><i class="icon-base bx bx-trash icon-md"></i></button>
              </div>
          ...
          <div class="d-flex mb-4 align-items-center">
            <div class="flex-shrink-0">
              <img src="../../assets/img/icons/brands/dribbble.png" alt="dribbble" class="me-4" height="36" />
            </div>
            <div class="flex-grow-1 row align-items-center me-n1">
              <div class="col-7 mb-sm-0 mb-2">
          ...
          <div class="d-flex align-items-center">
            <div class="flex-shrink-0">
              <img src="../../assets/img/icons/brands/behance.png" alt="behance" class="me-4" height="36" />
            </div>
            <div class="flex-grow-1 row align-items-center me-n1">
              <div class="col-7 mb-sm-0 mb-2">
