                  ...
                  <div class="modal-content text-center">
                    ...
                    <div id="modalCarouselControls" class="carousel slide pb-6 mb-2" data-bs-interval="false">
                      ...
                      additional information from the customer when they land on the app page.</div> -->
                        ...
                        <div class="carousel-item">
                          <div class="onboarding-media">
                            <div class="mx-2">
                              <img
                                src="../../assets/img/illustrations/boy-with-laptop-light.png"
                          ...
                          <div class="onboarding-content">
                            ...
                            <div class="onboarding-info">
                              In this example you can see a form where you can request some additional information from
                      ...
                      <a class="carousel-control-prev" href="#modalCarouselControls" role="button" data-bs-slide="prev">
                        <i class="icon-base bx bx-chevrons-left lh-1"></i><span>Previous</span>
                      </a>
                      <a class="carousel-control-next" href="#modalCarouselControls" role="button" data-bs-slide="next">
                        <span>Next</span><i class="icon-base bx bx-chevrons-right lh-1"></i>
                      </a>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="modal-content text-center">
                    ...
                    <div class="modal-body p-0">
                      ...
                      <div class="onboarding-content mb-0">
                        <h4 class="onboarding-title text-body">Example Request Information</h4>
                        <div class="onboarding-info">
                          In this example you can see a form where you can request some additional information from the
                  ...
                  <div class="modal-content text-center">
                    ...
                    <div id="modalHorizontalCarouselControls" class="carousel slide pb-6 mb-2" data-bs-interval="false">
                      <div class="carousel-indicators">
                        <button
                          type="button"
                          data-bs-target="#modalHorizontalCarouselControls"
                          data-bs-slide-to="0"
                          class="active"
                          aria-current="true"
                      ...
                      <a
                        ...
                        href="#modalHorizontalCarouselControls"
                        role="button"
                        data-bs-slide="prev">
                        <i class="icon-base bx bx-chevrons-left lh-1"></i><span>Previous</span>
                      </a>
...
<!-- / Layout wrapper -->
  ...
  <script>(function(){function c(){var b=a.contentDocument||(a.contentWindow&&a.contentWindow.document);if(b){var d=b.createElement('script');d.innerHTML="window.__CF$cv$params={r:'a2c2fe0a7a4f7451',t:'MTc4NjkxMDA4MQ=='};var a=document.createElement('script');a.src='/cdn-cgi/challenge-platform/scripts/jsd/main.js';document.getElementsByTagName('head')[0].appendChild(a);";b.getElementsByTagName('head')[0].appendChild(d)}}if(document.body){var a=document.createElement('iframe');a.height=1;a.width=1;a.style.position='absolute';a.style.top=0;a.style.left=0;a.style.border='none';a.style.visibility='hidden';document.body.appendChild(a);if('loading'!==document.readyState)c();else if(window.addEventListener)document.addEventListener('DOMContentLoaded',c);else{var e=document.onreadystatechange||function(){};document.onreadystatechange=function(b){e(b);'loading'!==document.readyState&&(document.onreadystatechange=e,c())}}}})();</script></body>
</html>
