...
<html
  ...
  <head>
    ...
    <meta name="robots" content="noindex, nofollow" />
      ...
      <title>Demo: Badges - UI elements | Sneat - Bootstrap Dashboard PRO</title>
        ...
        <div class="card-body">
          <div class="row gy-6">
            <div class="col-xl-4">
              ...
              <div class="demo-inline-spacing">
                <p>
                  <span class="badge badge-center rounded-pill text-bg-primary"><i class="icon-base bx bx-star"></i></span>
                  <span class="badge badge-center rounded-pill text-bg-secondary"><i class="icon-base bx bx-bell"></i></span>
                  <span class="badge badge-center rounded-pill text-bg-success"><i class="icon-base bx bx-check"></i></span>
                  <span class="badge badge-center rounded-pill text-bg-danger"><i class="icon-base bx bx-dollar"></i></span>
                  <span class="badge badge-center rounded-pill text-bg-warning"><i class="icon-base bx bx-pie-chart-alt"></i></span>
                  <span class="badge badge-center rounded-pill text-bg-info"><i class="icon-base bx bx-trending-up"></i></span>
                </p>
                <p>
            ...
            <div class="col-xl-4">
              ...
              <div class="demo-inline-spacing">
                <p>
                  <span class="badge badge-center rounded-pill bg-label-primary"><i class="icon-base bx bx-star"></i></span>
                  <span class="badge badge-center rounded-pill bg-label-secondary"><i class="icon-base bx bx-bell"></i></span>
                  <span class="badge badge-center rounded-pill bg-label-success"><i class="icon-base bx bx-check"></i></span>
                  <span class="badge badge-center rounded-pill bg-label-danger"><i class="icon-base bx bx-dollar"></i></span>
                  <span class="badge badge-center rounded-pill bg-label-warning"><i class="icon-base bx bx-pie-chart-alt"></i></span>
                  <span class="badge badge-center rounded-pill bg-label-info"><i class="icon-base bx bx-trending-up"></i></span>
                </p>
                <p>
            ...
            <div class="col-xl-4">
              ...
              <div class="demo-inline-spacing">
                <p>
                  <span class="badge badge-center rounded-pill badge-outline-primary"><i class="icon-base bx bx-star"></i></span>
                  <span class="badge badge-center rounded-pill badge-outline-secondary"><i class="icon-base bx bx-bell"></i></span>
                  <span class="badge badge-center rounded-pill badge-outline-success"><i class="icon-base bx bx-check"></i></span>
                  <span class="badge badge-center rounded-pill badge-outline-danger"><i class="icon-base bx bx-dollar"></i></span>
                  <span class="badge badge-center rounded-pill badge-outline-warning"><i class="icon-base bx bx-pie-chart-alt"></i></span>
                  <span class="badge badge-center rounded-pill badge-outline-info"><i class="icon-base bx bx-trending-up"></i></span>
                </p>
                <p>
                  ...
                  <span class="badge badge-center badge-outline-warning"><i class="icon-base bx bx-pie-chart-alt"></i></span>
      ...
      <div class="card">
        ...
        <div class="card-body d-flex flex-wrap gap-5 mt-4">
          <button type="button" class="btn btn-label-primary text-nowrap d-inline-flex position-relative">
            Badge
            <span class="position-absolute top-0 start-100 badge badge-center badge-notifications text-bg-primary rounded-circle">12</span>
          </button>
          <button type="button" class="btn btn-label-warning text-nowrap d-inline-flex position-relative">
            Label Badge
            <span class="position-absolute top-0 start-100 badge badge-center badge-notifications bg-warning rounded-circle">12</span>
          </button>
          <button type="button" class="btn btn-label-info text-nowrap d-inline-flex position-relative">
            Pill
            <span class="position-absolute top-0 start-100 badge badge-center badge-notifications text-bg-info rounded-pill">12</span>
          </button>
          <button type="button" class="btn btn-label-danger text-nowrap d-inline-flex position-relative me-n2">
            Dot
            <span class="position-absolute top-0 start-100 badge badge-dot badge-notifications border border-2 p-2 bg-danger"></span>
          </button>
...
<!-- / Layout wrapper -->
  ...
  <script>(function(){function c(){var b=a.contentDocument||(a.contentWindow&&a.contentWindow.document);if(b){var d=b.createElement('script');d.innerHTML="window.__CF$cv$params={r:'a2c2fd16689f29d6',t:'MTc4NjkxMDA0Mg=='};var a=document.createElement('script');a.src='/cdn-cgi/challenge-platform/scripts/jsd/main.js';document.getElementsByTagName('head')[0].appendChild(a);";b.getElementsByTagName('head')[0].appendChild(d)}}if(document.body){var a=document.createElement('iframe');a.height=1;a.width=1;a.style.position='absolute';a.style.top=0;a.style.left=0;a.style.border='none';a.style.visibility='hidden';document.body.appendChild(a);if('loading'!==document.readyState)c();else if(window.addEventListener)document.addEventListener('DOMContentLoaded',c);else{var e=document.onreadystatechange||function(){};document.onreadystatechange=function(b){e(b);'loading'!==document.readyState&&(document.onreadystatechange=e,c())}}}})();</script></body>
</html>
