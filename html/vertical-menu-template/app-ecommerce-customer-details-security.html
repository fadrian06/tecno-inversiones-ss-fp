...
<html
  ...
  <head>
    ...
    <meta name="robots" content="noindex, nofollow" />
      ...
      <title>Demo: eCommerce Customer Details Security - Pages | Sneat - Bootstrap Dashboard PRO</title>
          ...
          <div class="info-container">
            ...
            <ul class="list-unstyled mb-6">
              ...
              <li class="mb-2">
                ...
                <span><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="87f1e6e1e0e8f3c7f1f2ebf3f2eceef5a9e8f5e0">[email&#160;protected]</a></span>
              </li>
              <li class="mb-2">
    ...
    <div class="col-xl-8 col-lg-7 col-md-7 order-0 order-md-1">
      ...
      <div class="nav-align-top">
        <ul class="nav nav-pills flex-column flex-md-row mb-6 row-gap-2 flex-wrap">
          ...
          <li class="nav-item">
            <a class="nav-link active" href="javascript:void(0);"><i class="icon-base bx bx-lock icon-18px me-1_5"></i>Security</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="app-ecommerce-customer-details-billing.html"><i class="icon-base bx bx-map icon-18px me-1_5"></i>Address & Billing</a>
          </li>
          <li class="nav-item">
        ...
        <div class="card-body">
          ...
          <div class="mb-4">
            <div class="d-flex w-100 action-icons">
              <input id="defaultInput" class="form-control me-4 phone-number-mask" type="text" placeholder="968 945 8832" />
              <a href="javascript:;" class="btn btn-icon" data-bs-target="#enableOTP" data-bs-toggle="modal"><i class="icon-base bx bx-edit icon-md text-heading"></i></a>
              <a href="javascript:;" class="btn btn-icon"><i class="icon-base bx bx-user-plus icon-md text-heading"></i></a>
            </div>
          </div>
          <p class="mb-0">
      ...
      <div class="card mb-6">
        ...
        <div class="table-responsive">
          <table class="table border-top table-border-bottom-0">
            ...
            <tbody>
              <tr>
                <td class="text-truncate text-heading fw-medium"><i class="icon-base bx bxl-windows icon-md text-info me-2"></i>Chrome on Windows</td>
                <td class="text-truncate">HP Spectre 360</td>
                <td class="text-truncate">Switzerland</td>
                <td class="text-truncate">10, July 2021 20:07</td>
              </tr>
              <tr>
                <td class="text-truncate text-heading fw-medium"><i class="mb-1 icon-base bx bx-mobile-alt icon-md text-danger me-2"></i>Chrome on iPhone</td>
                <td class="text-truncate">iPhone 12x</td>
                <td class="text-truncate">Australia</td>
                <td class="text-truncate">13, July 2021 10:10</td>
              </tr>
              <tr>
                <td class="text-truncate text-heading fw-medium"><i class="mb-1 icon-base bx bxl-android icon-md text-success me-2"></i>Chrome on Android</td>
                <td class="text-truncate">Oneplus 9 Pro</td>
                <td class="text-truncate">Dubai</td>
                <td class="text-truncate">14, July 2021 15:15</td>
              </tr>
              <tr>
                <td class="text-truncate text-heading fw-medium"><i class="mb-1 icon-base bx bxl-apple icon-md text-secondary me-2"></i>Chrome on MacOS</td>
...
<!-- / Layout wrapper -->
  ...
  <script>(function(){function c(){var b=a.contentDocument||(a.contentWindow&&a.contentWindow.document);if(b){var d=b.createElement('script');d.innerHTML="window.__CF$cv$params={r:'a2c2e6db1fbb695e',t:'MTc4NjkwOTEzMg=='};var a=document.createElement('script');a.src='/cdn-cgi/challenge-platform/scripts/jsd/main.js';document.getElementsByTagName('head')[0].appendChild(a);";b.getElementsByTagName('head')[0].appendChild(d)}}if(document.body){var a=document.createElement('iframe');a.height=1;a.width=1;a.style.position='absolute';a.style.top=0;a.style.left=0;a.style.border='none';a.style.visibility='hidden';document.body.appendChild(a);if('loading'!==document.readyState)c();else if(window.addEventListener)document.addEventListener('DOMContentLoaded',c);else{var e=document.onreadystatechange||function(){};document.onreadystatechange=function(b){e(b);'loading'!==document.readyState&&(document.onreadystatechange=e,c())}}}})();</script></body>
</html>
