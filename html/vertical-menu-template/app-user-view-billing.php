          ...
          <div class="info-container">
            <ul class="list-unstyled mb-6">
              ...
              <li class="mb-2">
                ...
                <span><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="97e1f6f1f0f8e3d7e1e2fbe3e2fcfee5b9f8e5f0">[email&#160;protected]</a></span>
              </li>
              <li class="mb-2">
    ...
    <div class="col-xl-8 col-lg-7 order-0 order-md-1">
      ...
      <div class="nav-align-top">
        <ul class="nav nav-pills flex-column flex-md-row mb-6 flex-wrap row-gap-2">
          <li class="nav-item">
            <a class="nav-link" href="app-user-view-account.html"><i class="icon-base bx bx-user me-1_5 icon-sm"></i>Account</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="app-user-view-security.html"><i class="icon-base bx bx-lock-alt me-1_5 icon-sm"></i>Security</a>
          </li>
          <li class="nav-item">
            <a class="nav-link active" href="javascript:void(0);"><i class="icon-base bx bx-detail me-1_5 icon-sm"></i>Billing & Plans</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="app-user-view-notifications.html"><i class="icon-base bx bx-bell me-1_5 icon-sm"></i>Notifications</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="app-user-view-connections.html"><i class="icon-base bx bx-link me-1_5 icon-sm"></i>Connections</a>
          </li>
        </ul>
      </div>
      <!--/ User Pills -->
      ...
      <div class="card card-action mb-6">
        <div class="card-header align-items-center">
          ...
          <div class="card-action-element">
            <button class="btn btn-primary btn-sm" type="button" data-bs-toggle="modal" data-bs-target="#addNewCCModal"><i class="icon-base bx bx-plus icon-xs me-1_5"></i>Add Card</button>
          </div>
        </div>
        <div class="card-body">
          <div class="added-cards">
            ...
            <div class="cardMaster border p-6 rounded mb-4">
              <div class="d-flex justify-content-between flex-sm-row flex-column">
                <div class="card-information">
                  <img class="mb-2" src="../../assets/img/icons/payments/visa.png" alt="Master Card" height="25" />
            ...
            <div class="cardMaster border p-6 rounded">
              <div class="d-flex justify-content-between flex-sm-row flex-column">
                <div class="card-information">
                  <img class="mb-2" src="../../assets/img/icons/payments/american-express-logo.png" alt="Visa Card" height="25" />
                  <div class="d-flex align-items-center mb-2">
      ...
      <div class="card card-action mb-4">
        <div class="card-header align-items-center flex-wrap gap-2">
          ...
          <div class="card-action-element">
            <button class="btn btn-primary btn-sm edit-address" type="button" data-bs-toggle="modal" data-bs-target="#addNewAddress"><i class="icon-base bx bx-plus icon-xs me-1_5"></i>Edit address</button>
          </div>
        </div>
        <div class="card-body">
          <div class="row">
            <div class="col-xl-7 col-12">
              <dl class="row mb-0 gx-2">
                ...
                <dd class="col-sm-8"><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="d7a2a4b2a597b2aff9b4b8ba">[email&#160;protected]</a></dd>
...
<!-- / Layout wrapper -->
  ...
  <script>(function(){function c(){var b=a.contentDocument||(a.contentWindow&&a.contentWindow.document);if(b){var d=b.createElement('script');d.innerHTML="window.__CF$cv$params={r:'a2c2eb87dc101dd8',t:'MTc4NjkwOTMyMw=='};var a=document.createElement('script');a.src='/cdn-cgi/challenge-platform/scripts/jsd/main.js';document.getElementsByTagName('head')[0].appendChild(a);";b.getElementsByTagName('head')[0].appendChild(d)}}if(document.body){var a=document.createElement('iframe');a.height=1;a.width=1;a.style.position='absolute';a.style.top=0;a.style.left=0;a.style.border='none';a.style.visibility='hidden';document.body.appendChild(a);if('loading'!==document.readyState)c();else if(window.addEventListener)document.addEventListener('DOMContentLoaded',c);else{var e=document.onreadystatechange||function(){};document.onreadystatechange=function(b){e(b);'loading'!==document.readyState&&(document.onreadystatechange=e,c())}}}})();</script></body>
</html>
