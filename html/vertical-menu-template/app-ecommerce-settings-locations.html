...
<html
  ...
  <head>
    ...
    <meta name="robots" content="noindex, nofollow" />
      ...
      <title>Demo: Settings Locations - eCommerce | Sneat - Bootstrap Dashboard PRO</title>
      ...
      <div class="tab-content p-0">
        ...
        <div class="tab-pane fade show active" id="locations" role="tabpanel">
          <div class="card mb-6">
            ...
            <div class="card-body">
              ...
              <div class="alert row alert-info mb-0 h6" role="alert">
                <span class="col-3 alert-icon me-0 rounded-circle px-0"><i class="icon-base bx bx-info-circle icon-18px"></i></span>
                <div class="col text-wrap ps-3 pe-0">This is your default location. To change whether you fulfill online orders from this location, select another default location first.</div>
              </div>
            </div>
          </div>
          <div class="card mb-6">
          ...
          <div class="d-flex justify-content-end gap-4">
            ...
            <a class="btn btn-primary" href="app-ecommerce-settings-notifications.html">Save Changes</a>
          </div>
        </div>
      </div>
      <!-- /Options-->
...
<!-- / Layout wrapper -->
  ...
  <script>(function(){function c(){var b=a.contentDocument||(a.contentWindow&&a.contentWindow.document);if(b){var d=b.createElement('script');d.innerHTML="window.__CF$cv$params={r:'a2c2e84598094077',t:'MTc4NjkwOTE5MA=='};var a=document.createElement('script');a.src='/cdn-cgi/challenge-platform/scripts/jsd/main.js';document.getElementsByTagName('head')[0].appendChild(a);";b.getElementsByTagName('head')[0].appendChild(d)}}if(document.body){var a=document.createElement('iframe');a.height=1;a.width=1;a.style.position='absolute';a.style.top=0;a.style.left=0;a.style.border='none';a.style.visibility='hidden';document.body.appendChild(a);if('loading'!==document.readyState)c();else if(window.addEventListener)document.addEventListener('DOMContentLoaded',c);else{var e=document.onreadystatechange||function(){};document.onreadystatechange=function(b){e(b);'loading'!==document.readyState&&(document.onreadystatechange=e,c())}}}})();</script></body>
</html>
