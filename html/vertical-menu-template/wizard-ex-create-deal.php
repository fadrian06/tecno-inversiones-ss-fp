...
<html
  ...
  <head>
    ...
    <meta name="robots" content="noindex, nofollow" />
      ...
      <title>Demo: Create Deal - Wizard Examples | Sneat - Bootstrap Dashboard PRO</title>
    ...
    <div class="bs-stepper-content">
      <form id="wizard-create-deal-form" onSubmit="return false">
        ...
        <div id="deal-type" class="content">
          <div class="row g-6">
            <div class="col-12">
              <img src="../../assets/img/illustrations/shopping-girl-light.png" class="img-fluid w-100 border rounded-2" alt="shopping girl" data-app-dark-img="illustrations/shopping-girl-dark.png" data-app-light-img="illustrations/shopping-girl-light.png" />
            </div>
            <div class="col-12">
              <div class="row">
        ...
        <div id="deal-usage" class="content">
          <div class="row g-6">
            ...
            <div class="col-12 d-flex justify-content-between">
              ...
              <button class="btn btn-primary btn-next"><span class="align-middle d-sm-inline-block d-none me-sm-2">Next</span> <i class="icon-base bx bx-right-arrow-alt icon-sm me-sm-n2 scaleX-n1-rtl"></i></button>
            </div>
          </div>
        </div>
        <!-- Review & Complete -->
        <div id="review-complete" class="content">
          <div class="row g-6">
            ...
            <div class="col-lg-6 d-flex align-items-center justify-content-center">
              <img class="img-fluid" width="334" src="../../assets/img/illustrations/girl-checkout-offer-light.png" alt="deal image cap" data-app-light-img="illustrations/girl-checkout-offer-light.png" data-app-dark-img="illustrations/girl-checkout-offer-dark.png" />
            </div>
...
<!-- / Layout wrapper -->
  ...
  <script>(function(){function c(){var b=a.contentDocument||(a.contentWindow&&a.contentWindow.document);if(b){var d=b.createElement('script');d.innerHTML="window.__CF$cv$params={r:'a2c2fb7329bd86b6',t:'MTc4NjkwOTk3NQ=='};var a=document.createElement('script');a.src='/cdn-cgi/challenge-platform/scripts/jsd/main.js';document.getElementsByTagName('head')[0].appendChild(a);";b.getElementsByTagName('head')[0].appendChild(d)}}if(document.body){var a=document.createElement('iframe');a.height=1;a.width=1;a.style.position='absolute';a.style.top=0;a.style.left=0;a.style.border='none';a.style.visibility='hidden';document.body.appendChild(a);if('loading'!==document.readyState)c();else if(window.addEventListener)document.addEventListener('DOMContentLoaded',c);else{var e=document.onreadystatechange||function(){};document.onreadystatechange=function(b){e(b);'loading'!==document.readyState&&(document.onreadystatechange=e,c())}}}})();</script></body>
</html>
